  ...
  proc chpl_memTracking_returnConfigVals(ref ret_memTrack: bool,
    ...
    if (here.id != 0) {
      if !memLeaksByDesc.isEmpty() {
        ...
        ret_memLeaksByDesc = local_memLeaksByDesc:c_ptrConst(c_char):c_string;
      } else {
      ...
      if !memLog.isEmpty() {
        ...
        ret_memLog = local_memLog:c_ptrConst(c_char):c_string;
      } else {
        ret_memLog = nil;
      }
      ...
      if !memLeaksLog.isEmpty() {
        ...
        ret_memLeaksLog = local_memLeaksLog:c_ptrConst(c_char):c_string;
      } else {
        ret_memLeaksLog = nil;
      }

     } else {
      ret_memLeaksByDesc = memLeaksByDesc:c_ptrConst(c_char):c_string;
      ret_memLog = memLog:c_ptrConst(c_char):c_string;
      ret_memLeaksLog = memLeaksLog:c_ptrConst(c_char):c_string;
    }
  }
}
