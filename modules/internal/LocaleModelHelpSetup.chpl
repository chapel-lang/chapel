...
module LocaleModelHelpSetup {
  ...
  proc helpSetupRootLocaleFlat(dst:borrowed RootLocale) {
    ...
    forall locIdx in dst.chpl_initOnLocales() with (ref root_accum) {
      const node = new unmanaged LocaleModelMod.LocaleModel(dst);
  ...
  proc helpSetupLocaleFlat(dst:borrowed LocaleModelMod.LocaleModel, out local_name:string) {
  ...
  proc helpSetupLocaleNUMA(dst:borrowed LocaleModelMod.LocaleModel, out local_name:string, out numSublocales) {
  ...
  proc helpSetupLocaleAPU(dst:borrowed LocaleModelMod.LocaleModel, out local_name:string, out numSublocales) {
    helpSetupLocaleFlat(dst, local_name);
