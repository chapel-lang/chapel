...
module ChapelBase {
  ...
  pragma "init copy fn"
  inline proc chpl__initCopy(definedConst: bool, type t) type {
  ...
  pragma "last resort"
  pragma "init copy fn"
  inline proc chpl__initCopy(definedConst: bool, x: _tuple) {
  ...
  inline proc chpl__initCopy(definedConst: bool, const x) {
  ...
  pragma "last resort"
  pragma "auto copy fn"
  inline proc chpl__autoCopy(definedConst: bool, x: _tuple) {
    // body inserted during generic instantiation
  }
  ...
  pragma "compiler generated"
  pragma "auto copy fn"
  inline proc chpl__autoCopy(definedConst: bool, ir: _iteratorRecord) {
  ...
  pragma "auto copy fn"
  pragma "suppress lvalue error"
  inline proc chpl__autoCopy(definedConst: bool, const x) {
    return chpl__initCopy(definedConst, x);
  }
