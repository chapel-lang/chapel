// ChapelBase.chpl
//
// <2011-07-06 hilde> I had to move this here to avoid the 
// "initialization sequencing" bug.
...
pragma "private" var _here : locale = new baseLocale(uid=-1);
//_here.alloc(1,1,1,"a"); // Somehow including this enables dynamic dispatch. wtf
...
// This variable would be more logical in ChapelLocale.chpl,
// but I ran into the nasty "initialization sequencing"
// bug when I did that.
//

// <2011-07-06 hilde> Moved these here from ChapelRealm.chpl 
// to avoid the "initialization sequencing" bug.
//pragma "private" var _here = new baseLocale(r = nil, id = -1, uid = -1, numCores = 1);
//pragma "private" var _here: locale = new baseLocale(uid=-1);
///////var doneCreatingLocales: bool;
// <2011-07-06 hilde> Moved this here from DefaultRectangular.chpl.
//
...
//proc here return _here;
//pragma "initialize prelocale" proc locale_workaround() return new locale();
//pragma "private" var _here : locale = _here_init;
