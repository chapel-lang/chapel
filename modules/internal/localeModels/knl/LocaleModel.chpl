  ...
  */
  ...
  class LocaleModel : AbstractLocaleModel {
    ...
    override proc getChild(idx:int) : locale {
      ...
      if memoryKind == memoryKindMCDRAM() then
        return new locale(childLocales[whichNuma].hbm!);
      else
        return new locale(childLocales[whichNuma]);
    }
