...
// this = curl file
// arg: fl_local -> a file to read the data into. 
// Brief: This replicates the semantics of calling curl_easy_perform perform, after
//        setting CURLOPT_WRITEDATA to a FILE* for fl_local.
...
// this = curl file
// arg: str -> the string to read data into.
// Brief: This calls curl_easy_perform, and puts the output into str
...
// Note: _internal is not ref counted. Therefore the user is responsible for freeing
