...
pragma "inline" def <(a: int(8), b: int(8)) return __primitive("<", a, b);
pragma "inline" def >(a: int(8), b: int(8)) return __primitive(">", a, b);
pragma "inline" def !(a: int(8)) return __primitive("!", a);
pragma "inline" def &&(a: int(8), b: int(8)) return __primitive("&&", a, b);
pragma "inline" def ||(a: int(8), b: int(8)) return __primitive("||", a, b);
...
pragma "inline" def <(a: int(16), b: int(16)) return __primitive("<", a, b);
pragma "inline" def >(a: int(16), b: int(16)) return __primitive(">", a, b);
pragma "inline" def !(a: int(16)) return __primitive("!", a);
pragma "inline" def &&(a: int(16), b: int(16)) return __primitive("&&", a, b);
pragma "inline" def ||(a: int(16), b: int(16)) return __primitive("||", a, b);
...
pragma "inline" def =(a: int(64), b: int(64)) return b;
//pragma "inline" def _copy(a: int(64)) return a;
...
pragma "inline" def <(a: uint(8), b: uint(8)) return __primitive("<", a, b);
pragma "inline" def >(a: uint(8), b: uint(8)) return __primitive(">", a, b);
pragma "inline" def !(a: uint(8)) return __primitive("!", a);
pragma "inline" def &&(a: uint(8), b: uint(8)) return __primitive("&&", a, b);
pragma "inline" def ||(a: uint(8), b: uint(8)) return __primitive("||", a, b);
...
pragma "inline" def <(a: uint(16), b: uint(16)) return __primitive("<", a, b);
pragma "inline" def >(a: uint(16), b: uint(16)) return __primitive(">", a, b);
pragma "inline" def !(a: uint(16)) return __primitive("!", a);
pragma "inline" def &&(a: uint(16), b: uint(16)) return __primitive("&&", a, b);
pragma "inline" def ||(a: uint(16), b: uint(16)) return __primitive("||", a, b);
...
pragma "inline" def =(a: uint(64), b: uint(64)) return b;
//pragma "inline" def _copy(a: uint(64)) return a;
...
pragma "inline" def =(a: float(32), b: float) return b:float(32);
//pragma "inline" def _copy(a: float(32)) return a;
pragma "inline" def +(a: float(32)) return __primitive("u+", a);
pragma "inline" def -(a: float(32)) return __primitive("u-", a);
pragma "inline" def +(a: float(32), b: float(32)) return __primitive("+", a, b);
pragma "inline" def -(a: float(32), b: float(32)) return __primitive("-", a, b);
pragma "inline" def *(a: float(32), b: float(32)) return __primitive("*", a, b);
pragma "inline" def /(a: float(32), b: float(32)) return __primitive("/", a, b);
pragma "inline" def **(a: float(32), b: float(32)) return __primitive("**", a, b);
...
pragma "inline" def <(a: float(32), b: float(32)) return __primitive("<", a, b);
pragma "inline" def >(a: float(32), b: float(32)) return __primitive(">", a, b);
pragma "inline" def !(a: float(32)) return __primitive("!", a);
pragma "inline" def &&(a: float(32), b: float(32)) return __primitive("&&", a, b);
pragma "inline" def ||(a: float(32), b: float(32)) return __primitive("||", a, b);

// Primitive functions and operators on float(64)
pragma "inline" def =(a: float(64), b: float(64)) return b;
//pragma "inline" def _copy(a: float(64)) return a;
pragma "inline" def +(a: float(64)) return __primitive("u+", a);
pragma "inline" def -(a: float(64)) return __primitive("u-", a);
pragma "inline" def +(a: float(64), b: float(64)) return __primitive("+", a, b);
pragma "inline" def -(a: float(64), b: float(64)) return __primitive("-", a, b);
pragma "inline" def *(a: float(64), b: float(64)) return __primitive("*", a, b);
pragma "inline" def /(a: float(64), b: float(64)) return __primitive("/", a, b);
pragma "inline" def **(a: float(64), b: float(64)) return __primitive("**", a, b);
