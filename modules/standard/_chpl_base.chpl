...
// errors on uint(64) and int(64) to keep from becoming float
// pragma "inline" def +(a: int(64), b: uint(64)) {
//  compilerError("illegal use of '+' on operands of type int(64) and uint(64)");
// }
// pragma "inline" def -(a: int(64), b: uint(64)) {
//  compilerError("illegal use of '-' on operands of type int(64) and uint(64)");
// }
...
// pragma "inline" def +(a: uint(64), b: int(64)) {
//  compilerError("illegal use of '+' on operands of type uint(64) and int(64)");
// }
// pragma "inline" def -(a: uint(64), b: int(64)) {
//  compilerError("illegal use of '-' on operands of type uint(64) and int(64)");
// }
