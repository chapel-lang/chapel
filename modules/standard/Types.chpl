...
def numBits(type t) where t == bool return 1;
...
def numBits(type t) where t == imag(32) return 32;
def numBits(type t) where t == imag(64) return 64;
def numBits(type t) where t == imag(128) return 128;
