    ...
    class NPBRandomStream {
      ...
      */
      ...
      /*
        ...
        :proc:`SeedGenerators.oddCurrentTime <SeedGenerators.oddCurrentTime>`..
        :type seed: int(64)
  ...
  */
  module PCGRandom {
    ...
    /*
      ...
      This class builds upon the `pcg_setseq_64_xsh_rr_32_rng` PCG RNG
      ...
      The random numbers generated by this class, when eltType=uint(32),
      match those generated by the C PCG reference implementation.

      Smaller numbers, such as uint(8) or uint(16), are generated from
      the high-order bits of the 32-output.

      To generate larger numbers, these 32-bit-output RNGs are ganged together.
      This strategy is based on pcg32x2-demo.c which is a strategy recommended
      by the author of PCG. Each of these 32-bit RNGs has a different sequence
      constant and so will be independent and uncorrelated.  For example, to
      generate 128-bit complex numbers, this RNG will use
      4 ganged 32-bit PCG RNGs with different sequence constants. One impact
      of this approach is that this implementation will only generate
      2**64 different complex numbers (for example).

      When generating a real, imaginary, or complex number, this implementation
      uses the strategy of scaling by a number of bits in the mantissa.
      For example, real(64)s are generated by generating 53 random bits
      and then multiplying by 2**-53. This strategy leaves out many possible
      random real values.
    ...
    class RandomStream {
      ...
      */
      ...
      /*
        ...
        :arg seed: The seed to use for the PRNG.  Defaults to :proc:`SeedGenerators.currentTime`..
        :type seed: int(64)
