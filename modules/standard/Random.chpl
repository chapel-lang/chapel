...
module Random {
  ...
  */
  ...
  /*
    ...
    they can generate 0.0 and 1.0.  (e.g. The can be generated by
  ...
  */
  ...
  /*
     ...
     .. note::
       ...
       This interface provided by this module is expected to change.
  ...
  */
  module PCGRandom {
    ...
    /*
      ...
      in a range and in support for generating random `real` s.
    ...
    */
    class RandomStream {
      /*
        ...
        All numeric types are supported: int, uint, of all sizes,
