...
module GPU
{
  ...
  */
  ...
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_LINEAR_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_MIPMAPPED_WIDTH : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LINEAR_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LINEAR_HEIGHT : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LINEAR_PITCH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_MIPMAPPED_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_MIPMAPPED_HEIGHT : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE3D_WIDTH_ALTERNATE : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE3D_HEIGHT_ALTERNATE : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE3D_DEPTH_ALTERNATE : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURECUBEMAP_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_LAYERED_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_LAYERED_LAYERS : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LAYERED_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LAYERED_HEIGHT : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LAYERED_LAYERS : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURECUBEMAP_LAYERED_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURECUBEMAP_LAYERED_LAYERS : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE1D_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_HEIGHT : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE3D_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE3D_HEIGHT : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE3D_DEPTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE1D_LAYERED_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE1D_LAYERED_LAYERS : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_LAYERED_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_LAYERED_HEIGHT : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_LAYERED_LAYERS : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACECUBEMAP_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACECUBEMAP_LAYERED_WIDTH : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACECUBEMAP_LAYERED_LAYERS : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__GPU_OVERLAP : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__COMPUTEMODE_DEFAULT : c_int;
  extern const CHPL_GPU_ATTRIBUTE__COMPUTEMODE_PROHIBITED : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__PCI_DOMAIN_ID : c_int;
  extern const CHPL_GPU_ATTRIBUTE__TCC_DRIVER : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__UNIFIED_ADDRESSING : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__GLOBAL_L1_CACHE_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__LOCAL_L1_CACHE_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAX_SHARED_MEMORY_PER_MULTIPROCESSOR : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAX_REGISTERS_PER_MULTIPROCESSOR : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MANAGED_MEMORY : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MULTI_GPU_BOARD : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MULTI_GPU_BOARD_GROUP_ID : c_int;
  extern const CHPL_GPU_ATTRIBUTE__HOST_NATIVE_ATOMIC_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__SINGLE_TO_DOUBLE_PRECISION_PERF_RATIO : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__COMPUTE_PREEMPTION_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__CAN_USE_HOST_POINTER_FOR_REGISTERED_MEM : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAX_SHARED_MEMORY_PER_BLOCK_OPTIN : c_int;
  ...
  extern const CHPL_GPU_ATTRIBUTE__VIRTUAL_MEMORY_MANAGEMENT_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__HANDLE_TYPE_POSIX_FILE_DESCRIPTOR_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__HANDLE_TYPE_WIN32_HANDLE_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__HANDLE_TYPE_WIN32_KMT_HANDLE_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAX_BLOCKS_PER_MULTIPROCESSOR : c_int;
  extern const CHPL_GPU_ATTRIBUTE__GENERIC_COMPRESSION_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAX_PERSISTING_L2_CACHE_SIZE : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MAX_ACCESS_POLICY_WINDOW_SIZE : c_int;
  extern const CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_WITH_CUDA_VMM_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__RESERVED_SHARED_MEMORY_PER_BLOCK : c_int;
  extern const CHPL_GPU_ATTRIBUTE__SPARSE_CUDA_ARRAY_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__READ_ONLY_HOST_REGISTER_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MEMORY_POOLS_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_SUPPORTED : c_int;
  extern const CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_FLUSH_WRITES_OPTIONS : c_int;
  extern const CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_WRITES_ORDERING : c_int;
  extern const CHPL_GPU_ATTRIBUTE__MEMPOOL_SUPPORTED_HANDLE_TYPES : c_int;
  extern const CHPL_GPU_ATTRIBUTE__DEFERRED_MAPPING_CUDA_ARRAY_SUPPORTED : c_int;
  ...
  record DeviceAttributes {
    ...
    proc maximumTexture1dLinearWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_LINEAR_WIDTH);
    proc maximumTexture1dMipmappedWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_MIPMAPPED_WIDTH);
    ...
    proc maximumTexture2dLinearWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LINEAR_WIDTH);
    proc maximumTexture2dLinearHeight : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LINEAR_HEIGHT);
    proc maximumTexture2dLinearPitch : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LINEAR_PITCH);
    proc maximumTexture2dMipmappedWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_MIPMAPPED_WIDTH);
    proc maximumTexture2dMipmappedHeight : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_MIPMAPPED_HEIGHT);
    ...
    proc maximumTexture3dWidthAlternate : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE3D_WIDTH_ALTERNATE);
    proc maximumTexture3dHeightAlternate : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE3D_HEIGHT_ALTERNATE);
    proc maximumTexture3dDepthAlternate : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE3D_DEPTH_ALTERNATE);
    proc maximumTexturecubemapWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURECUBEMAP_WIDTH);
    proc maximumTexture1dLayeredWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_LAYERED_WIDTH);
    proc maximumTexture1dLayeredLayers : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE1D_LAYERED_LAYERS);
    proc maximumTexture2dLayeredWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LAYERED_WIDTH);
    proc maximumTexture2dLayeredHeight : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LAYERED_HEIGHT);
    proc maximumTexture2dLayeredLayers : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURE2D_LAYERED_LAYERS);
    proc maximumTexturecubemapLayeredWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURECUBEMAP_LAYERED_WIDTH);
    proc maximumTexturecubemapLayeredLayers : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_TEXTURECUBEMAP_LAYERED_LAYERS);
    proc maximumSurface1dWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE1D_WIDTH);
    proc maximumSurface2dWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_WIDTH);
    proc maximumSurface2dHeight : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_HEIGHT);
    proc maximumSurface3dWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE3D_WIDTH);
    proc maximumSurface3dHeight : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE3D_HEIGHT);
    proc maximumSurface3dDepth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE3D_DEPTH);
    proc maximumSurface1dLayeredWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE1D_LAYERED_WIDTH);
    proc maximumSurface1dLayeredLayers : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE1D_LAYERED_LAYERS);
    proc maximumSurface2dLayeredWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_LAYERED_WIDTH);
    proc maximumSurface2dLayeredHeight : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_LAYERED_HEIGHT);
    proc maximumSurface2dLayeredLayers : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACE2D_LAYERED_LAYERS);
    proc maximumSurfacecubemapWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACECUBEMAP_WIDTH);
    proc maximumSurfacecubemapLayeredWidth : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACECUBEMAP_LAYERED_WIDTH);
    proc maximumSurfacecubemapLayeredLayers : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAXIMUM_SURFACECUBEMAP_LAYERED_LAYERS);
    ...
    proc gpuOverlap : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__GPU_OVERLAP);
    ...
    proc computemodeDefault : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__COMPUTEMODE_DEFAULT);
    proc computemodeProhibited : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__COMPUTEMODE_PROHIBITED);
    proc process : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__PROCESS);
    ...
    proc pciDomainId : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__PCI_DOMAIN_ID);
    proc tccDriver : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__TCC_DRIVER);
    ...
    proc unifiedAddressing : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__UNIFIED_ADDRESSING);
    ...
    proc globalL1CacheSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__GLOBAL_L1_CACHE_SUPPORTED);
    proc localL1CacheSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__LOCAL_L1_CACHE_SUPPORTED);
    ...
    proc maxRegistersPerMultiprocessor : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAX_REGISTERS_PER_MULTIPROCESSOR);
    ...
    proc multiGpuBoardGroupId : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MULTI_GPU_BOARD_GROUP_ID);
    proc hostNativeAtomicSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__HOST_NATIVE_ATOMIC_SUPPORTED);
    proc singleToDoublePrecisionPerfRatio : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__SINGLE_TO_DOUBLE_PRECISION_PERF_RATIO);
    ...
    proc computePreemptionSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__COMPUTE_PREEMPTION_SUPPORTED);
    proc canUseHostPointerForRegisteredMem : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__CAN_USE_HOST_POINTER_FOR_REGISTERED_MEM);
    proc maxSharedMemoryPerBlockOptin : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAX_SHARED_MEMORY_PER_BLOCK_OPTIN);
    ...
    proc virtualMemoryManagementSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__VIRTUAL_MEMORY_MANAGEMENT_SUPPORTED);
    proc handleTypePosixFileDescriptorSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__HANDLE_TYPE_POSIX_FILE_DESCRIPTOR_SUPPORTED);
    proc handleTypeWin32HandleSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__HANDLE_TYPE_WIN32_HANDLE_SUPPORTED);
    proc handleTypeWin32KmtHandleSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__HANDLE_TYPE_WIN32_KMT_HANDLE_SUPPORTED);
    proc maxBlocksPerMultiprocessor : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAX_BLOCKS_PER_MULTIPROCESSOR);
    proc genericCompressionSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__GENERIC_COMPRESSION_SUPPORTED);
    proc maxPersistingL2CacheSize : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAX_PERSISTING_L2_CACHE_SIZE);
    proc maxAccessPolicyWindowSize : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MAX_ACCESS_POLICY_WINDOW_SIZE);
    proc gpuDirectRdmaWithCudaVmmSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_WITH_CUDA_VMM_SUPPORTED);
    proc reservedSharedMemoryPerBlock : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__RESERVED_SHARED_MEMORY_PER_BLOCK);
    proc sparseCudaArraySupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__SPARSE_CUDA_ARRAY_SUPPORTED);
    proc readOnlyHostRegisterSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__READ_ONLY_HOST_REGISTER_SUPPORTED);
    proc memoryPoolsSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MEMORY_POOLS_SUPPORTED);
    proc gpuDirectRdmaSupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_SUPPORTED);
    proc gpuDirectRdmaFlushWritesOptions : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_FLUSH_WRITES_OPTIONS);
    proc gpuDirectRdmaWritesOrdering : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__GPU_DIRECT_RDMA_WRITES_ORDERING);
    proc mempoolSupportedHandleTypes : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__MEMPOOL_SUPPORTED_HANDLE_TYPES);
    proc deferredMappingCudaArraySupported : int do return chpl_gpu_query_attribute(this.gpuId : c_int, CHPL_GPU_ATTRIBUTE__DEFERRED_MAPPING_CUDA_ARRAY_SUPPORTED);
  }
}
