...
module Sys {
  ...
  */
  ...
  extern proc sys_set_sys_sockaddr_t(ref addr: sys_sockaddr_t, host: c_ptrConst(c_char), port: c_uint, family: c_int):c_int;
  ...
  // --- deprecated with no replacement ---
  extern proc sys_open(pathname:c_ptrConst(c_char), flags:c_int, mode:mode_t, ref fd_out:c_int):qio_err_t;
  ...
  extern proc getaddrinfo(node:c_ptrConst(c_char), service:c_ptrConst(c_char), ref hints:sys_addrinfo_t, ref res_out:sys_addrinfo_ptr_t):qio_err_t;
