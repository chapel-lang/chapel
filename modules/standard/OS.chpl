...
*/
  ...
  */
  ...
  /*
    Gets the matching :class:`IoError` subtype for given ``errorCode``, or
  ...
  */
  ...
  /*
     :class:`IoError` serves as the base class for all errors regarding inputs
     and their formatting. They are typically not directly generated by the OS,
     but they are used and emitted by the IO module.
