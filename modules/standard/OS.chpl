...
*/
  ...
  */
  ...
  /*
    Gets the corresponding IO error class for the given ``errorCode``, or
    simply the matching :class:`SystemError` subtype if this is not a
    Chapel-specific IO error.
  */
  pragma "no doc"
