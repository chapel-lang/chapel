...
module NetCDF {
  ...
  module C_NetCDF {
    ...
    extern const NC_FILL_STRING : c_ptrConst(c_uchar);
    ...
    extern const _FillValue : c_ptrConst(c_uchar);
    ...
    extern const DIM_WITHOUT_VARIABLE : c_ptrConst(c_uchar);
    ...
    extern proc nc_inq_libvers() : c_ptrConst(c_uchar);

    extern proc nc_strerror(ncerr : c_int) : c_ptrConst(c_uchar);

    extern proc nc__create(path : c_ptrConst(c_uchar), cmode : c_int, initialsz : c_size_t, ref chunksizehintp : c_size_t, ref ncidp : c_int) : c_int;

    extern proc nc_create(path : c_ptrConst(c_uchar), cmode : c_int, ref ncidp : c_int) : c_int;

    extern proc nc__open(path : c_ptrConst(c_uchar), mode : c_int, ref chunksizehintp : c_size_t, ref ncidp : c_int) : c_int;

    extern proc nc_open(path : c_ptrConst(c_uchar), mode : c_int, ref ncidp : c_int) : c_int;

    extern proc nc_inq_path(ncid : c_int, ref pathlen : c_size_t, path : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_inq_ncid(ncid : c_int, name : c_ptrConst(c_uchar), ref grp_ncid : c_int) : c_int;

    extern proc nc_inq_grps(ncid : c_int, ref numgrps : c_int, ref ncids : c_int) : c_int;

    extern proc nc_inq_grpname(ncid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_inq_grpname_full(ncid : c_int, ref lenp : c_size_t, full_name : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_inq_grp_ncid(ncid : c_int, grp_name : c_ptrConst(c_uchar), ref grp_ncid : c_int) : c_int;

    extern proc nc_inq_grp_full_ncid(ncid : c_int, full_name : c_ptrConst(c_uchar), ref grp_ncid : c_int) : c_int;
    ...
    extern proc nc_def_grp(parent_ncid : c_int, name : c_ptrConst(c_uchar), ref new_ncid : c_int) : c_int;

    extern proc nc_rename_grp(grpid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_def_compound(ncid : c_int, size : c_size_t, name : c_ptrConst(c_uchar), ref typeidp : nc_type) : c_int;

    extern proc nc_insert_compound(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), offset : c_size_t, field_typeid : nc_type) : c_int;

    extern proc nc_insert_array_compound(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), offset : c_size_t, field_typeid : nc_type, ndims : c_int, ref dim_sizes : c_int) : c_int;

    extern proc nc_inq_type(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), ref size : c_size_t) : c_int;

    extern proc nc_inq_typeid(ncid : c_int, name : c_ptrConst(c_uchar), ref typeidp : nc_type) : c_int;

    extern proc nc_inq_compound(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), ref sizep : c_size_t, ref nfieldsp : c_size_t) : c_int;

    extern proc nc_inq_compound_name(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_inq_compound_field(ncid : c_int, xtype : nc_type, fieldid : c_int, name : c_ptrConst(c_uchar), ref offsetp : c_size_t, ref field_typeidp : nc_type, ref ndimsp : c_int, ref dim_sizesp : c_int) : c_int;

    extern proc nc_inq_compound_fieldname(ncid : c_int, xtype : nc_type, fieldid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_inq_compound_fieldindex(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), ref fieldidp : c_int) : c_int;
    ...
    extern proc nc_def_vlen(ncid : c_int, name : c_ptrConst(c_uchar), base_typeid : nc_type, ref xtypep : nc_type) : c_int;

    extern proc nc_inq_vlen(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), ref datum_sizep : c_size_t, ref base_nc_typep : nc_type) : c_int;
    ...
    extern proc nc_inq_user_type(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), ref size : c_size_t, ref base_nc_typep : nc_type, ref nfieldsp : c_size_t, ref classp : c_int) : c_int;

    extern proc nc_put_att(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, op : c_ptr(void)) : c_int;

    extern proc nc_get_att(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ip : c_ptr(void)) : c_int;

    extern proc nc_def_enum(ncid : c_int, base_typeid : nc_type, name : c_ptrConst(c_uchar), ref typeidp : nc_type) : c_int;

    extern proc nc_insert_enum(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), value : c_ptr(void)) : c_int;

    extern proc nc_inq_enum(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), ref base_nc_typep : nc_type, ref base_sizep : c_size_t, ref num_membersp : c_size_t) : c_int;

    extern proc nc_inq_enum_member(ncid : c_int, xtype : nc_type, idx : c_int, name : c_ptrConst(c_uchar), value : c_ptr(void)) : c_int;

    extern proc nc_inq_enum_ident(ncid : c_int, xtype : nc_type, value : c_longlong, identifier : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_def_opaque(ncid : c_int, size : c_size_t, name : c_ptrConst(c_uchar), ref xtypep : nc_type) : c_int;

    extern proc nc_inq_opaque(ncid : c_int, xtype : nc_type, name : c_ptrConst(c_uchar), ref sizep : c_size_t) : c_int;
    ...
    extern proc nc_def_dim(ncid : c_int, name : c_ptrConst(c_uchar), len : c_size_t, ref idp : c_int) : c_int;

    extern proc nc_inq_dimid(ncid : c_int, name : c_ptrConst(c_uchar), ref idp : c_int) : c_int;

    extern proc nc_inq_dim(ncid : c_int, dimid : c_int, name : c_ptrConst(c_uchar), ref lenp : c_size_t) : c_int;

    extern proc nc_inq_dimname(ncid : c_int, dimid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_inq_dimlen(ncid : c_int, dimid : c_int, ref lenp : c_size_t) : c_int;

    extern proc nc_rename_dim(ncid : c_int, dimid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_inq_att(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref xtypep : nc_type, ref lenp : c_size_t) : c_int;

    extern proc nc_inq_attid(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref idp : c_int) : c_int;

    extern proc nc_inq_atttype(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref xtypep : nc_type) : c_int;

    extern proc nc_inq_attlen(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref lenp : c_size_t) : c_int;

    extern proc nc_inq_attname(ncid : c_int, varid : c_int, attnum : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_copy_att(ncid_in : c_int, varid_in : c_int, name : c_ptrConst(c_uchar), ncid_out : c_int, varid_out : c_int) : c_int;

    extern proc nc_rename_att(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), newname : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_del_att(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_put_att_text(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), len : c_size_t, op : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_get_att_text(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ip : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_put_att_string(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), len : c_size_t, ref op : c_ptr(c_uchar)) : c_int;

    extern proc nc_get_att_string(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_ptr(c_uchar)) : c_int;

    extern proc nc_put_att_uchar(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_uchar) : c_int;

    extern proc nc_get_att_uchar(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_uchar) : c_int;

    extern proc nc_put_att_schar(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_schar) : c_int;

    extern proc nc_get_att_schar(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_schar) : c_int;

    extern proc nc_put_att_short(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_short) : c_int;

    extern proc nc_get_att_short(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_short) : c_int;

    extern proc nc_put_att_int(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_int) : c_int;

    extern proc nc_get_att_int(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_int) : c_int;

    extern proc nc_put_att_long(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_long) : c_int;

    extern proc nc_get_att_long(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_long) : c_int;

    extern proc nc_put_att_float(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_float) : c_int;

    extern proc nc_get_att_float(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_float) : c_int;

    extern proc nc_put_att_double(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_double) : c_int;

    extern proc nc_get_att_double(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_double) : c_int;

    extern proc nc_put_att_ushort(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_ushort) : c_int;

    extern proc nc_get_att_ushort(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_ushort) : c_int;

    extern proc nc_put_att_uint(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_uint) : c_int;

    extern proc nc_get_att_uint(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_uint) : c_int;

    extern proc nc_put_att_longlong(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_longlong) : c_int;

    extern proc nc_get_att_longlong(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_longlong) : c_int;

    extern proc nc_put_att_ulonglong(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_ulonglong) : c_int;

    extern proc nc_get_att_ulonglong(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_ulonglong) : c_int;

    extern proc nc_def_var(ncid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, ndims : c_int, ref dimidsp : c_int, ref varidp : c_int) : c_int;

    extern proc nc_inq_var(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref xtypep : nc_type, ref ndimsp : c_int, ref dimidsp : c_int, ref nattsp : c_int) : c_int;

    extern proc nc_inq_varid(ncid : c_int, name : c_ptrConst(c_uchar), ref varidp : c_int) : c_int;

    extern proc nc_inq_varname(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_rename_var(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_copy_var(ncid_in : c_int, varid : c_int, ncid_out : c_int) : c_int;

    extern proc nc_put_var1_text(ncid : c_int, varid : c_int, ref indexp : c_size_t, op : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_get_var1_text(ncid : c_int, varid : c_int, ref indexp : c_size_t, ip : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_put_vara_text(ncid : c_int, varid : c_int, ref startp : c_size_t, ref countp : c_size_t, op : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_get_vara_text(ncid : c_int, varid : c_int, ref startp : c_size_t, ref countp : c_size_t, ip : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_put_vars_text(ncid : c_int, varid : c_int, ref startp : c_size_t, ref countp : c_size_t, ref stridep : c_ptrdiff, op : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_get_vars_text(ncid : c_int, varid : c_int, ref startp : c_size_t, ref countp : c_size_t, ref stridep : c_ptrdiff, ip : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_put_varm_text(ncid : c_int, varid : c_int, ref startp : c_size_t, ref countp : c_size_t, ref stridep : c_ptrdiff, ref imapp : c_ptrdiff, op : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_get_varm_text(ncid : c_int, varid : c_int, ref startp : c_size_t, ref countp : c_size_t, ref stridep : c_ptrdiff, ref imapp : c_ptrdiff, ip : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_put_var_text(ncid : c_int, varid : c_int, op : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_get_var_text(ncid : c_int, varid : c_int, ip : c_ptrConst(c_uchar)) : c_int;
    ...
    extern proc nc_put_att_ubyte(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_size_t, ref op : c_uchar) : c_int;

    extern proc nc_get_att_ubyte(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref ip : c_uchar) : c_int;
    ...
    extern proc nc__create_mp(path : c_ptrConst(c_uchar), cmode : c_int, initialsz : c_size_t, basepe : c_int, ref chunksizehintp : c_size_t, ref ncidp : c_int) : c_int;

    extern proc nc__open_mp(path : c_ptrConst(c_uchar), mode : c_int, basepe : c_int, ref chunksizehintp : c_size_t, ref ncidp : c_int) : c_int;

    extern proc nc_delete(path : c_ptrConst(c_uchar)) : c_int;

    extern proc nc_delete_mp(path : c_ptrConst(c_uchar), basepe : c_int) : c_int;
    ...
    extern proc nc_advise(cdf_routine_name : c_ptrConst(c_uchar), err : c_int, fmt : c_ptrConst(c_uchar), c__varargs ...) : void;

    // Overload for empty varargs
    extern proc nc_advise(cdf_routine_name : c_ptrConst(c_uchar), err : c_int,fmt : c_ptrConst(c_uchar)) : void;

    extern proc nccreate(path : c_ptrConst(c_uchar), cmode : c_int) : c_int;

    extern proc ncopen(path : c_ptrConst(c_uchar), mode : c_int) : c_int;
    ...
    extern proc ncdimdef(ncid : c_int, name : c_ptrConst(c_uchar), len : c_long) : c_int;

    extern proc ncdimid(ncid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc ncdiminq(ncid : c_int, dimid : c_int, name : c_ptrConst(c_uchar), ref lenp : c_long) : c_int;

    extern proc ncdimrename(ncid : c_int, dimid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc ncattput(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, len : c_int, op : c_ptr(void)) : c_int;

    extern proc ncattinq(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref xtypep : nc_type, ref lenp : c_int) : c_int;

    extern proc ncattget(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ip : c_ptr(void)) : c_int;

    extern proc ncattcopy(ncid_in : c_int, varid_in : c_int, name : c_ptrConst(c_uchar), ncid_out : c_int, varid_out : c_int) : c_int;

    extern proc ncattname(ncid : c_int, varid : c_int, attnum : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc ncattrename(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), newname : c_ptrConst(c_uchar)) : c_int;

    extern proc ncattdel(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc ncvardef(ncid : c_int, name : c_ptrConst(c_uchar), xtype : nc_type, ndims : c_int, ref dimidsp : c_int) : c_int;

    extern proc ncvarid(ncid : c_int, name : c_ptrConst(c_uchar)) : c_int;

    extern proc ncvarinq(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar), ref xtypep : nc_type, ref ndimsp : c_int, ref dimidsp : c_int, ref nattsp : c_int) : c_int;
    ...
    extern proc ncvarrename(ncid : c_int, varid : c_int, name : c_ptrConst(c_uchar)) : c_int;
