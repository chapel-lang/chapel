...
proc ReplicatedDim.dsiPrivatize1d(privatizeData) {
  return new raw ReplicatedDim(numLocales = privatizeData(1));
}
...
proc Replicated1dom.dsiPrivatize1d(privDist, privatizeData) {
  ...
  return new raw Replicated1dom(idxType   = this.idxType,
                                  ...
                                  type stoIndexT)
{
  ...
  return new raw Replicated1dom(idxType, stridable);
}
...
proc Replicated1dom.dsiNewLocalDom1d(type stoIndexT, locId: locIdT) {
  return new raw Replicated1locdom(stoIndexT, wholeR.stridable);
}
