...
#ifdef __cplusplus
#define SEGFAULT() *static_cast<volatile int*>(nullptr) = 0 /* deliberately segfault. */
#else
#define SEGFAULT() *(volatile int*)(NULL) = 0 /* deliberately segfault. */
#endif
