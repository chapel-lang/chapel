...
const char* chpl_rt_memDescs[] = {
  ...
  "stm tx active message commit ph1 arg",
  "stm tx active message commit ph2 data",
  "stm tx active message commit ph2 arg",
  "stm tx active message get wrapper data",
  "stm tx active message get wrapper arg",
  "stm tx active message get data",
  "stm tx active message get arg",
