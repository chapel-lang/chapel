...
err_t sys_preadv(fd_t fd, struct iovec* iov, int iovcnt, int64_t seek_to_offset, ssize_t* num_read_out);
err_t sys_pwritev(fd_t fd, const struct iovec* iov, int iovcnt, int64_t seek_to_offset, ssize_t* num_written_out);
