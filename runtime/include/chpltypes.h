...
chpl_string string_copy(c_string x, int32_t lineno, c_string filename);
...
chpl_string string_concat(c_string x, c_string y, int32_t lineno, c_string filename);
int string_index_of(c_string x, c_string y);
chpl_string string_index(c_string x, int i, int32_t lineno, c_string filename);
chpl_string string_select(c_string x, int low, int high, int stride, int32_t lineno, c_string filename);
