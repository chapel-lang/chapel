use StencilDist, CommDiagnostics;

config const n = 11;


// test a standard block distribution
const D = {1..n, 1..n} dmapped new stencilDist({1..n, 1..n});
var A: [D] real;
...
if (numLocales == 4) {
  ...
  const D = {1..n, 1..n} dmapped new stencilDist({1..n, 1..n}, targetLocales = targetLocs);
  var A: [D] real;
