...
const dd1 =new sdist(numLocales=tl1, boundingBoxLow=start1, boundingBoxHigh=end1);
const dd2 =new sdist(numLocales=tl2, boundingBoxLow=start2, boundingBoxHigh=end2);
