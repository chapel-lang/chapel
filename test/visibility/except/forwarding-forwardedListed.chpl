// Tests the behavior when listing a forwarded type in the except list of a used
// module that defines a tertiary method on the forwarded type.
module definesType {
  record Container {
...
module User {
  ...
  use definesTertiary except OtherType;
