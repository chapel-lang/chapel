// Tests the behavior when listing a grandparent type in the only list of a used
// module that defines a tertiary method on a grandparent type.
module definesClass {
  class Grandparent {
    var a: int;
  }
...
module User {
  ...
  use definesTertiary only Grandparent;
