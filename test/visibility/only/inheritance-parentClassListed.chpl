// Tests the behavior when listing a parent type in the only list of a used
// module that defines a tertiary method on a parent type.
module definesClass {
  class Parent {
    var a: int;
  }
...
module User {
  ...
  use definesTertiary only Parent;
