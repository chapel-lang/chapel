// Tests the behavior when listing a forwarded type in the import list when
// importing a module that defines a tertiary method on the forwarded type.
...
module User {
  ...
  import definesTertiary.OtherType;
