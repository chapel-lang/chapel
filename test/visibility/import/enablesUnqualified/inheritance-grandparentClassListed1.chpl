// Tests the behavior when listing a grandparent type in the import list when
// importing a module that defines a tertiary method on a grandparent type.
...
module User {
  ...
  import definesTertiary.Grandparent;

  proc main() {
    var x = new owned Child(2, 3);
    x.tertiaryMethod(); // This means this should work
  }
}
