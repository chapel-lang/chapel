...
proc testeq(param a: enum, param b: enum) param do return a==b;
proc testneq(param a: enum, param b: enum) param do return a!=b;
proc testgt(param a: enum, param b: enum) param do return a>b;
proc testgte(param a: enum, param b: enum) param do return a>=b;
proc testlt(param a: enum, param b: enum) param do return a<b;
proc testlte(param a: enum, param b: enum) param do return a<=b;
