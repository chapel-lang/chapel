...
writeln("Hello World!");
writeln("Hello World!":c_ptrConst(c_char):c_string:string);

writeln(b"Hello World!");
writeln(b"Hello World!":c_ptrConst(c_char):c_string:string);
...
{
  var s = "Hello World!";
  var cptr = s:c_ptrConst(c_char):c_string:c_void_ptr:c_ptr(uint(8));
  cptr[0] = 66; // 'B'
  writeln("Hello World!");
  writeln(s);
  writeln(s:c_ptrConst(c_char):c_string:string);
}
