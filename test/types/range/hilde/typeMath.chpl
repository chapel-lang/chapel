...
writeln(typeToString((1:int(8)..100:uint).type));
...
writeln(typeToString((1:int(16)..100:uint).type));
...
writeln(typeToString((1:int(32)..100:uint).type));
...
writeln(typeToString((1:int(32)..100:uint(64)).type));
...
writeln(typeToString((1:uint..100:int(8)).type));
writeln(typeToString((1:uint..100:int(16)).type));
writeln(typeToString((1:uint..100:int(32)).type));
...
writeln(typeToString((1:uint(64)..100:int(32)).type));
