...
unstridableRange = stridableRange: range(stridable=false);
...
unstridableRange = stridableRangeUnit.safeCast(range(stridable=false));
...
unstridableRange = stridableRange.safeCast(range(stridable=false));
