def modify1(p1, p2, (c1, c2, c3)) { return (c1 * p1 + c2 * p2) / c3; }
def modify2(p1, p2, (c1, c2, c3)) { return (c1 * p1 - c2 * p2) / c3; }
var parameters1 = (2.34, (3.45, 4.56, 5),    modify1);
var parameters2 = (2,    (3,    4,    5.67), modify2);

class Operate { var z1, z2; }
def do_op(p1, p2, o:Operate) { return o.z1 * p1 + o.z2 * p2; }
...
def merge(a1, a2, result, i, end, o, (c0, p, fn)) {
  while (i <= end) do
