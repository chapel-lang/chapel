def compute(a1, a2, result, i, end, o, (c0, p, fn)) {
  while (i <= end) do {
...
def g1(p1, p2, (c1, c2)) { return c1 * p1 + c2 * p2; }
def g2(p1, p2, (c1, c2, c3)) { return (c1 * p1 - c2 * p2) / c3; }
...
def FParams::f(p1, p2) { return z1 * p1 + z2 * p2; }
