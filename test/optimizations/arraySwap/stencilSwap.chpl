...
writeln("*** Stencil ***");
{
  ...
  var d1 = {1..10} dmapped Stencil({1..10});
...

{
  ...
  var d1 = {1..10} dmapped Stencil({1..10});
  var d2 = {0..9} dmapped Stencil({0..9});
...

{
  ...
  var d1 = {0..9} dmapped Stencil({1..10});
  var d2 = {0..9} dmapped Stencil({1..10});
...

{
  ...
  var d1 = {0..9 by 2} dmapped Stencil({1..10});
  var d2 = {0..9 by 2} dmapped Stencil({1..10});
...

{
  ...
  var d1 = {0..9 by 2 align 0} dmapped Stencil({1..10});
  var d2 = {0..9 by 2 align 1} dmapped Stencil({1..10});
