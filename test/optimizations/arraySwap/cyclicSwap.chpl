...
writeln("*** Cyclic ***");
{
  ...
  var d1 = {1..10} dmapped Cyclic(1);
  var d2 = {1..10} dmapped Cyclic(1);
...

{
  ...
  var d1 = {0..9 by 2} dmapped Cyclic(1);
  var d2 = {0..9 by 2} dmapped Cyclic(1);
...

{
  ...
  var d1 = {0..9 by 2} dmapped Cyclic(1);
  var d2 = {1..10 by 2} dmapped Cyclic(1);
...

{
  ...
  var d1 = {0..9 by 2 align 0} dmapped Cyclic(0);
  var d2 = {0..9 by 2 align 1} dmapped Cyclic(1);
...

{
  ...
  // abundance of caution
  writeln("both are strided and misaligned");
  var d1 = {0..9 by 2 align 1} dmapped Cyclic(1);
