...
proc printCommDiagnostics(id, s) {
  ...
  writeln(s, "(Locale", id, "): forks: ", diagnostics.execute_on);
  writeln(s, "(Locale", id, "): fast forks: ", diagnostics.execute_on_fast);
  writeln(s, "(Locale", id, "): nb forks: ", diagnostics.execute_on_nb);
}
