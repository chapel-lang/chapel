...
var d2Dist1 = new Block({1..n,1..n});
var d2Dist2 = new Block({1..(2*n),1..(2*n)});
...
if printTime then writeln("Example 1. Time elapsed: ", dt);
  //for (a,i) in zip(d2A,{1..n*n}) do a=i;
writeln();
...
var d3Dist1 = new Block({1..p,1..p,1..p});
var d3Dist2 = new Block({1..2*p,1..2*p,1..2*p});
...
var d4Dist1 = new Block({1..q,1..q,1..q,1..q});
var d4Dist2 = new Block({1..2*q,1..2*q,1..2*q,1..2*q});
