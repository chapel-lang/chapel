...
for (a,b) in (A[Dom1],B[Dom2]) do if (a!=b) then {writeln("ERROR!!!!");}

Dom1 = {1..n/2 by 2};
Dom2 = {1..n by 4};
writeln("Example 2: B",Dom2,"(",Dom2.numIndices,") = A",Dom1,"(",Dom1.numIndices,")");
...
{
	D[Dom4]=C[Dom3];
	for (a,b) in (C[Dom3],D[Dom4]) do if (a!=b) then {writeln("ERROR!!!!");}
}
...
Dom1 = {1..n by 4};
writeln("Example 21: A: ",Dom1,"(",Dom1.numIndices,") = E: ",Dom5,"(",Dom5.numIndices,")");
if (Dom1.numIndices == Dom5.numIndices)
{
	A[Dom1]=E[Dom5];
	for (a,b) in (A[Dom1],E[Dom5]) do if (a!=b) then {writeln("ERROR!!!!");}
}
