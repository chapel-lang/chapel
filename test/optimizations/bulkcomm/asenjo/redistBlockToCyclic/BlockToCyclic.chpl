...
proc BlockArr.copyBtoC(B)
{
  coforall loc in Locales do on loc
  {
    ...
    var numLocales: int(32)=privdom.dist.targetLocDom.dim(0).length:int(32);
    var n:int(32)=privdom.dist.boundingBox.dim(0).length:int(32);
...
proc  BlockArr.copyCtoB(B)
{
  ...
  coforall loc in Locales do on loc
  {
    ...
    var count: [1..#(stridelevels+1)] int(32); 
    var lid=loc.id;
    var numLocales: int=privdom.dist.targetLocDom.dim(0).length;
    var n:int(32)=privdom.dist.boundingBox.dim(0).length:int(32);
