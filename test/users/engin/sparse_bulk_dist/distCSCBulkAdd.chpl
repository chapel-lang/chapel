...
var space = {1..10, 1..10};
var parentDomCSR = space dmapped blockDist(space, sparseLayoutType=CS(compressRows=true));
var spsDomCSR: sparse subdomain(parentDomCSR);
var parentDomCSC = space dmapped blockDist(space, sparseLayoutType=CS(compressRows=false));
