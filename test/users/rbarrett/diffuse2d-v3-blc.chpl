   ...
   do
      {
         ...
         ApplyStencil2d5ptB ( ProblemSpace2d, grid2, grid1, iteration );
         iteration += 1;
         ...
         ApplyStencil2d5ptB ( ProblemSpace2d, grid1, grid2, iteration );
   ...
   do
      {
         ...
         ApplyStencil2d5ptC ( ProblemSpace2d, grid2, grid1, iteration );
         iteration += 1;
         ...
         ApplyStencil2d5ptC ( ProblemSpace2d, grid1, grid2, iteration );
   ...
   do
      {
         ...
         ApplyStencil2d9pt ( ProblemSpace2d, grid2, grid1, iteration );
         iteration += 1;
         ...
         ApplyStencil2d9pt ( ProblemSpace2d, grid1, grid2, iteration );
...
proc ApplyStencil2d5ptA ( ProblemSpace2d, ref newGrid, oldGrid, iteration ) {
...
proc ApplyStencil2d5ptB ( ProblemSpace2d, ref newGrid, oldGrid, iteration ) {
...
proc ApplyStencil2d5ptC ( ProblemSpace2d, ref newGrid, oldGrid, iteration ) {
...
proc ApplyStencil2d9pt ( ProblemSpace2d, ref newGrid, oldGrid, iteration ) {
...
proc ApplyStencil3d7pt ( ProblemSpace2d, ref newGrid, oldGrid, iteration ) {
   ...
   forall ijk in ProblemSpace2d do
