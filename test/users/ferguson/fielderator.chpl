...
assert(__primitive("has method by name", R, "something") == 1);
assert(__primitive("has method by name", R, "nothing") == 0);
...
writeln("has .something ", __primitive("has method by name", R, "something"));
writeln("has .nothing ", __primitive("has method by name", R, "nothing"));

var z:real;

if( __primitive("has method by name", R, "something")) {
  writeln("Calling .something");
  z = m.something();
}

if( __primitive("has method by name", R, "nothing")) {
  writeln("Calling .nothing");
  z = m.something();
}
