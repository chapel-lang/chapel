...
module myMPI {
  ...
  var worldSize : c_int;
  var worldRank : [LocaleSpace] c_int;
  ...
  proc setRankAndSize() {
    ...
    coforall iloc in LocaleSpace do 
      on Locales[iloc] {
        var locRank : c_int;
        C_MPI.MPI_Comm_rank(MPI_COMM_WORLD, locRank);
        worldRank[iloc] = locRank;
      }
  }
