...
proc smuAccumulate(hh : borrowed UniformBins, p1, p2 : []WeightedParticle3D, d1,d2 : domain(1), scale : real) {
...
proc TreeAccumulate(hh : borrowed UniformBins, p1, p2 : []WeightedParticle3D, node1, node2 : unmanaged KDNode) {
