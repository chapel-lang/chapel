...
ADR2[DDR4]=BDR2[DDR4];
for (a,b) in (ADR2[DDR4],BDR2[DDR4]) do if (a!=b) then writeln("ERROR!!!!");
...
ADR2[DDR6]=BDR2[DDR6];
for (a,b) in (ADR2[DDR6],BDR2[DDR6]) do if (a!=b) then writeln("ERROR!!!!");
...
for (a,b) in (ADR3[DDR13],BDR3[DDR13]) do if (a!=b) then writeln("ERROR!!!!");
...
for (a,b) in (ADR4[DDR14],BDR4[DDR14]) do if (a!=b) then writeln("ERROR!!!!");
...
A4[D4]=B4[D4];
for (a,b) in (A4[D4],B4[D4]) do if (a!=b) then writeln("ERROR!!!!");
