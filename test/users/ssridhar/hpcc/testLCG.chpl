...
//
config param safeUpdates: bool = true;
...
const LocaleDist = new dmap(new Block(boundingBox=[0..numLocales-1]));
const DistLocaleSpace: domain(1, int) dmapped LocaleDist = [0..numLocales-1] ;
var countRand: [DistLocaleSpace] elemType;
