// This is a snapshot of modules/dists/CyclicDist.chpl
// as of #22441, i.e., still using `stridable` as much as possible.
// It should still work as long as `stridable` is supported
// in "deprecated" mode.
