...
{
  use CTypes;
  extern proc return_c_ptrConstUchar_test():c_ptrConst(c_uchar);
  extern proc return_c_ptrConstUchar_arg_test(ref str: c_ptrConst(c_uchar));
  ...
  var s:string;
  on Locales(1) {
    var temp_cs: c_ptrConst(c_uchar);
