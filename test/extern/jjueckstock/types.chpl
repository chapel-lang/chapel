module OuterModule {
  ...
  var strct: C.my_struct = new my_struct(42, "bar":c_ptrConst(c_char):c_string);
  writeln(strct.foo);
  try {
  ...
  var b: bar;
  b.c = "Hello":c_ptrConst(c_char):c_string;
  b.foo = 42;
  ...
  printf("%.1f, %d\n":c_ptrConst(c_char):c_string, td_strct.d, td_strct2.x);
  printf("%s, %d\n":c_ptrConst(c_char):c_string, b.c, b.foo);
}
