...
const probSizes:   [Class] = _seq( 1400, 7000, 14000, 75000, 150000, 150000, 1400 ),
      nonZeroes:   [Class] = _seq( 7, 8, 11, 13, 15, 21, 7 ),
      shifts:      [Class] = _seq( 10, 12, 20, 60, 110, 500, 10 ),
      numIters:    [Class] = _seq( 15, 15, 15, 75, 75, 100, 15 ),
      verifyZetas: [Class] = _seq( 8.5971775078648, 10.362595087124,
