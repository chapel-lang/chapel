// test errors -- see overload at end of file to help with this
...
proc _domain.contains(args ...?numArgs) {
  compilerError("index rank and type must match the domain rank and type");
  return false;
}
