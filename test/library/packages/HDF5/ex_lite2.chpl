...
proc main {
  ...
  file_id = H5Fopen(c_ptrToConst_helper(pathPrefix + filename), H5F_ACC_RDONLY, H5P_DEFAULT);

  /* read the dataset */
  H5LTread_dataset_int(file_id, c_ptrToConst_helper("/dset"), data[0]);

  /* get the dimensions of the dataset */
  H5LTget_dataset_info_WAR(file_id, c_ptrToConst_helper("/dset"), c_ptrTo(dims), nil, nil);
