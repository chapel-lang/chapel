...
proc main {
  ...
  cdfError(nc_put_att_text(ncid, latVarId, units,
                           degNorth.numBytes, c_ptrToConst_helper(degNorth):c_string));
  cdfError(nc_put_att_text(ncid, lonVarId, units,
                           degEast.numBytes, c_ptrToConst_helper(degEast):c_string));
  ...
  cdfError(nc_put_att_text(ncid, presVarId, c_ptrToConst_helper(units):c_string,
                           presUnits.numBytes:c_size_t, c_ptrToConst_helper(presUnits):c_string));
  cdfError(nc_put_att_text(ncid, tempVarId, c_ptrToConst_helper(units):c_string,
                           tempUnits.numBytes:c_size_t, c_ptrToConst_helper(tempUnits):c_string));
