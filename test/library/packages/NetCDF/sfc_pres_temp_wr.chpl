...
proc main {
  ...
  cdfError(nc_put_att_text(ncid, latVarId, units,
                           degNorth.numBytes, degNorth:c_ptrConst(c_char):c_string));
  cdfError(nc_put_att_text(ncid, lonVarId, units,
                           degEast.numBytes, degEast:c_ptrConst(c_char):c_string));
  ...
  cdfError(nc_put_att_text(ncid, presVarId, units:c_ptrConst(c_char):c_string,
                           presUnits.numBytes:c_size_t, presUnits:c_ptrConst(c_char):c_string));
  cdfError(nc_put_att_text(ncid, tempVarId, units:c_ptrConst(c_char):c_string,
                           tempUnits.numBytes:c_size_t, tempUnits:c_ptrConst(c_char):c_string));
