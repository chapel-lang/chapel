...
if testReal {
  ...
  rs = getRNG();
  if crush then
    run_crush_testu01_double(name.localize():c_ptrConst(c_char):c_string);
  else
    run_smallcrush_testu01_double(name.localize():c_ptrConst(c_char):c_string);
} else {
  ...
  rs = getRNG();
  if crush then
    run_crush_testu01_uint(name.localize():c_ptrConst(c_char):c_string);
  else
    run_smallcrush_testu01_uint(name.localize():c_ptrConst(c_char):c_string);
}
