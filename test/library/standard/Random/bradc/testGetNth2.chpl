...
var randStr1 = new randomStream(real, 314159265, false);
var randStr2 = new randomStream(real, 314159265, false);
var randStr3 = new randomStream(real, 314159265, false);
