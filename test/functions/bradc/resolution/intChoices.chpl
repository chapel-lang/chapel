...
param8OrNot(sizes.big);
param8OrNot(aSize);
param8OrNot(anotherSize);
param8OrNot(SMALL);
...
twoInts(color.red, color.red);
twoInts(color.red, aColor);
twoInts(color.red, RED);
twoInts(color.red, Red);
twoInts(color.red, i8);
twoInts(color.red, i16);
twoInts(color.red, i32);
twoInts(color.red, i64);
twoInts(color.red, I8);
twoInts(color.red, I16);
twoInts(color.red, I32);
twoInts(color.red, I64);
twoInts(color.red, sizes.small);
twoInts(color.red, sizes.big);
twoInts(color.red, aSize);
twoInts(color.red, anotherSize);
twoInts(color.red, SMALL);
twoInts(color.red, BIG);
twoInts(color.red, Small);
twoInts(color.red, Big);
twoInts(color.red, 126);
twoInts(color.red, 131072);
writeln();

writeln("twoInts(aColor, *) variants");
twoInts(aColor, color.red);
twoInts(aColor, aColor);
twoInts(aColor, RED);
twoInts(aColor, Red);
twoInts(aColor, i8);
twoInts(aColor, i16);
...
twoInts(aColor, I32);
twoInts(aColor, I64);
twoInts(aColor, sizes.small);
twoInts(aColor, sizes.big);
twoInts(aColor, aSize);
twoInts(aColor, anotherSize);
twoInts(aColor, SMALL);
twoInts(aColor, BIG);
twoInts(aColor, Small);
twoInts(aColor, Big);
twoInts(aColor, 126);
twoInts(aColor, 131072);
writeln();


writeln("twoInts(RED, *) variants");
twoInts(RED, color.red);
twoInts(RED, aColor);
twoInts(RED, RED);
twoInts(RED, Red);
twoInts(RED, i8);
...
twoInts(RED, I32);
twoInts(RED, I64);
twoInts(RED, sizes.small);
twoInts(RED, sizes.big);
twoInts(RED, aSize);
twoInts(RED, anotherSize);
twoInts(RED, SMALL);
twoInts(RED, BIG);
twoInts(RED, Small);
twoInts(RED, Big);
...
twoInts(i8, I32);
twoInts(i8, I64);
twoInts(i8, sizes.small);
twoInts(i8, sizes.big);
twoInts(i8, aSize);
twoInts(i8, anotherSize);
twoInts(i8, SMALL);
twoInts(i8, BIG);
twoInts(i8, Small);
twoInts(i8, Big);
...
twoInts(i16, I32);
twoInts(i16, I64);
twoInts(i16, sizes.small);
twoInts(i16, sizes.big);
twoInts(i16, aSize);
twoInts(i16, anotherSize);
twoInts(i16, SMALL);
twoInts(i16, BIG);
twoInts(i16, Small);
twoInts(i16, Big);
...
twoInts(i32, I32);
twoInts(i32, I64);
twoInts(i32, sizes.small);
twoInts(i32, sizes.big);
twoInts(i32, aSize);
twoInts(i32, anotherSize);
twoInts(i32, SMALL);
twoInts(i32, BIG);
twoInts(i32, Small);
twoInts(i32, Big);
...
twoInts(i64, I32);
twoInts(i64, I64);
twoInts(i64, sizes.small);
twoInts(i64, sizes.big);
twoInts(i64, aSize);
twoInts(i64, anotherSize);
twoInts(i64, SMALL);
twoInts(i64, BIG);
twoInts(i64, Small);
twoInts(i64, Big);
...
twoInts(sizes.small, color.red);
twoInts(sizes.small, aColor);
twoInts(sizes.small, RED);
twoInts(sizes.small, Red);
twoInts(sizes.small, i8);
twoInts(sizes.small, i16);
twoInts(sizes.small, i32);
twoInts(sizes.small, i64);
twoInts(sizes.small, I8);
twoInts(sizes.small, I16);
twoInts(sizes.small, I32);
twoInts(sizes.small, I64);
twoInts(sizes.small, sizes.small);
twoInts(sizes.small, sizes.big);
twoInts(sizes.small, aSize);
twoInts(sizes.small, anotherSize);
twoInts(sizes.small, SMALL);
twoInts(sizes.small, BIG);
twoInts(sizes.small, Small);
twoInts(sizes.small, Big);
twoInts(sizes.small, 126);
twoInts(sizes.small, 131072);
writeln();


writeln("twoInts(sizes.big, *) variants");
twoInts(sizes.big, color.red);
twoInts(sizes.big, aColor);
twoInts(sizes.big, RED);
twoInts(sizes.big, Red);
twoInts(sizes.big, i8);
twoInts(sizes.big, i16);
twoInts(sizes.big, i32);
twoInts(sizes.big, i64);
twoInts(sizes.big, I8);
twoInts(sizes.big, I16);
twoInts(sizes.big, I32);
twoInts(sizes.big, I64);
twoInts(sizes.big, sizes.small);
twoInts(sizes.big, sizes.big);
twoInts(sizes.big, aSize);
twoInts(sizes.big, anotherSize);
twoInts(sizes.big, SMALL);
twoInts(sizes.big, BIG);
twoInts(sizes.big, Small);
twoInts(sizes.big, Big);
twoInts(sizes.big, 126);
twoInts(sizes.big, 131072);
writeln();


writeln("twoInts(aSize, *) variants");
twoInts(aSize, color.red);
twoInts(aSize, aColor);
twoInts(aSize, RED);
twoInts(aSize, Red);
twoInts(aSize, i8);
twoInts(aSize, i16);
...
twoInts(aSize, I32);
twoInts(aSize, I64);
twoInts(aSize, sizes.small);
twoInts(aSize, sizes.big);
twoInts(aSize, aSize);
twoInts(aSize, anotherSize);
twoInts(aSize, SMALL);
twoInts(aSize, BIG);
twoInts(aSize, Small);
twoInts(aSize, Big);
twoInts(aSize, 126);
twoInts(aSize, 131072);
writeln();


writeln("twoInts(anotherSize, *) variants");
twoInts(anotherSize, color.red);
twoInts(anotherSize, aColor);
twoInts(anotherSize, RED);
twoInts(anotherSize, Red);
twoInts(anotherSize, i8);
twoInts(anotherSize, i16);
twoInts(anotherSize, i32);
twoInts(anotherSize, i64);
twoInts(anotherSize, I8);
twoInts(anotherSize, I16);
twoInts(anotherSize, I32);
twoInts(anotherSize, I64);
twoInts(anotherSize, sizes.small);
twoInts(anotherSize, sizes.big);
twoInts(anotherSize, aSize);
twoInts(anotherSize, anotherSize);
twoInts(anotherSize, SMALL);
twoInts(anotherSize, BIG);
twoInts(anotherSize, Small);
twoInts(anotherSize, Big);
twoInts(anotherSize, 126);
twoInts(anotherSize, 131072);
writeln();


writeln("twoInts(SMALL, *) variants");
twoInts(SMALL, color.red);
twoInts(SMALL, aColor);
twoInts(SMALL, RED);
twoInts(SMALL, Red);
twoInts(SMALL, i8);
twoInts(SMALL, i16);
...
twoInts(SMALL, I32);
twoInts(SMALL, I64);
twoInts(SMALL, sizes.small);
twoInts(SMALL, sizes.big);
twoInts(SMALL, aSize);
twoInts(SMALL, anotherSize);
twoInts(SMALL, SMALL);
twoInts(SMALL, BIG);
twoInts(SMALL, Small);
twoInts(SMALL, Big);
...
twoInts(BIG, I32);
twoInts(BIG, I64);
twoInts(BIG, sizes.small);
twoInts(BIG, sizes.big);
twoInts(BIG, aSize);
twoInts(BIG, anotherSize);
twoInts(BIG, SMALL);
twoInts(BIG, BIG);
twoInts(BIG, Small);
twoInts(BIG, Big);
...
twoInts(126, I32);
twoInts(126, I64);
twoInts(126, sizes.small);
twoInts(126, sizes.big);
twoInts(126, aSize);
twoInts(126, anotherSize);
twoInts(126, SMALL);
twoInts(126, BIG);
twoInts(126, Small);
twoInts(126, Big);
...
twoInts(131072, color.red);
twoInts(131072, aColor);
twoInts(131072, RED);
twoInts(131072, Red);
twoInts(131072, i8);
twoInts(131072, i16);
...
twoInts(131072, I32);
twoInts(131072, I64);
twoInts(131072, sizes.small);
twoInts(131072, sizes.big);
twoInts(131072, aSize);
twoInts(131072, anotherSize);
...
intEnum(color.red, I32);
intEnum(color.red, I64);
intEnum(color.red, sizes.small);
intEnum(color.red, sizes.big);
intEnum(color.red, aSize);
intEnum(color.red, anotherSize);
...
intEnum(aColor, I32);
intEnum(aColor, I64);
intEnum(aColor, sizes.small);
intEnum(aColor, sizes.big);
intEnum(aColor, aSize);
intEnum(aColor, anotherSize);
...
intEnum(RED, I32);
intEnum(RED, I64);
intEnum(RED, sizes.small);
intEnum(RED, sizes.big);
intEnum(RED, aSize);
intEnum(RED, anotherSize);
intEnum(RED, SMALL);
intEnum(RED, BIG);
intEnum(RED, Small);
intEnum(RED, Big);
...
intEnum(i8, I32);
intEnum(i8, I64);
intEnum(i8, sizes.small);
intEnum(i8, sizes.big);
intEnum(i8, aSize);
intEnum(i8, anotherSize);
intEnum(i8, SMALL);
intEnum(i8, BIG);
intEnum(i8, Small);
intEnum(i8, Big);
...
intEnum(i16, I32);
intEnum(i16, I64);
intEnum(i16, sizes.small);
intEnum(i16, sizes.big);
intEnum(i16, aSize);
intEnum(i16, anotherSize);
intEnum(i16, SMALL);
intEnum(i16, BIG);
intEnum(i16, Small);
intEnum(i16, Big);
...
intEnum(i32, I32);
intEnum(i32, I64);
intEnum(i32, sizes.small);
intEnum(i32, sizes.big);
intEnum(i32, aSize);
intEnum(i32, anotherSize);
intEnum(i32, SMALL);
intEnum(i32, BIG);
intEnum(i32, Small);
intEnum(i32, Big);
...
intEnum(i64, I32);
intEnum(i64, I64);
intEnum(i64, sizes.small);
intEnum(i64, sizes.big);
intEnum(i64, aSize);
intEnum(i64, anotherSize);
intEnum(i64, SMALL);
intEnum(i64, BIG);
intEnum(i64, Small);
intEnum(i64, Big);
...
intEnum(sizes.small, color.red);
intEnum(sizes.small, aColor);
intEnum(sizes.small, RED);
intEnum(sizes.small, Red);
intEnum(sizes.small, i8);
intEnum(sizes.small, i16);
intEnum(sizes.small, i32);
intEnum(sizes.small, i64);
intEnum(sizes.small, I8);
intEnum(sizes.small, I16);
intEnum(sizes.small, I32);
intEnum(sizes.small, I64);
intEnum(sizes.small, sizes.small);
intEnum(sizes.small, sizes.big);
intEnum(sizes.small, aSize);
intEnum(sizes.small, anotherSize);
intEnum(sizes.small, SMALL);
intEnum(sizes.small, BIG);
intEnum(sizes.small, Small);
intEnum(sizes.small, Big);
intEnum(sizes.small, 126);
intEnum(sizes.small, 131072);
writeln();


writeln("intEnum(sizes.big, *) variants");
intEnum(sizes.big, color.red);
intEnum(sizes.big, aColor);
intEnum(sizes.big, RED);
intEnum(sizes.big, Red);
intEnum(sizes.big, i8);
intEnum(sizes.big, i16);
intEnum(sizes.big, i32);
intEnum(sizes.big, i64);
intEnum(sizes.big, I8);
intEnum(sizes.big, I16);
intEnum(sizes.big, I32);
intEnum(sizes.big, I64);
intEnum(sizes.big, sizes.small);
intEnum(sizes.big, sizes.big);
intEnum(sizes.big, aSize);
intEnum(sizes.big, anotherSize);
intEnum(sizes.big, SMALL);
intEnum(sizes.big, BIG);
intEnum(sizes.big, Small);
intEnum(sizes.big, Big);
intEnum(sizes.big, 126);
intEnum(sizes.big, 131072);
writeln();


writeln("intEnum(aSize, *) variants");
intEnum(aSize, color.red);
intEnum(aSize, aColor);
intEnum(aSize, RED);
intEnum(aSize, Red);
intEnum(aSize, i8);
intEnum(aSize, i16);
...
intEnum(aSize, I32);
intEnum(aSize, I64);
intEnum(aSize, sizes.small);
intEnum(aSize, sizes.big);
intEnum(aSize, aSize);
intEnum(aSize, anotherSize);
intEnum(aSize, SMALL);
intEnum(aSize, BIG);
intEnum(aSize, Small);
intEnum(aSize, Big);
intEnum(aSize, 126);
intEnum(aSize, 131072);
writeln();


writeln("intEnum(anotherSize, *) variants");
intEnum(anotherSize, color.red);
intEnum(anotherSize, aColor);
intEnum(anotherSize, RED);
intEnum(anotherSize, Red);
intEnum(anotherSize, i8);
intEnum(anotherSize, i16);
intEnum(anotherSize, i32);
intEnum(anotherSize, i64);
intEnum(anotherSize, I8);
intEnum(anotherSize, I16);
intEnum(anotherSize, I32);
intEnum(anotherSize, I64);
intEnum(anotherSize, sizes.small);
intEnum(anotherSize, sizes.big);
intEnum(anotherSize, aSize);
intEnum(anotherSize, anotherSize);
intEnum(anotherSize, SMALL);
intEnum(anotherSize, BIG);
intEnum(anotherSize, Small);
intEnum(anotherSize, Big);
intEnum(anotherSize, 126);
intEnum(anotherSize, 131072);
writeln();
...
intEnum(SMALL, I32);
intEnum(SMALL, I64);
intEnum(SMALL, sizes.small);
intEnum(SMALL, sizes.big);
intEnum(SMALL, aSize);
intEnum(SMALL, anotherSize);
intEnum(SMALL, SMALL);
intEnum(SMALL, BIG);
intEnum(SMALL, Small);
intEnum(SMALL, Big);
...
intEnum(BIG, I32);
intEnum(BIG, I64);
intEnum(BIG, sizes.small);
intEnum(BIG, sizes.big);
intEnum(BIG, aSize);
intEnum(BIG, anotherSize);
intEnum(BIG, SMALL);
intEnum(BIG, BIG);
intEnum(BIG, Small);
intEnum(BIG, Big);
...
intEnum(126, I32);
intEnum(126, I64);
intEnum(126, sizes.small);
intEnum(126, sizes.big);
intEnum(126, aSize);
intEnum(126, anotherSize);
intEnum(126, SMALL);
intEnum(126, BIG);
intEnum(126, Small);
intEnum(126, Big);
...
intEnum(131072, I32);
intEnum(131072, I64);
intEnum(131072, sizes.small);
intEnum(131072, sizes.big);
intEnum(131072, aSize);
intEnum(131072, anotherSize);
