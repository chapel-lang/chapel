...
var foo1: Foo(1) = new Foo(1); // specifies a different value
var foo2: Foo(3) = new Foo(); // relies on the default value
var foo3: Foo(3) = new Foo(3); // specifies the same value as the default
