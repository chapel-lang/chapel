...
proc examples() {
  ...
  // The release function can be used to delete the
  // managed object, if any.
  delete owned.release(owned5); // deletes C(5)
  writeln("after delete owned.release(owned5)");
  writeln("owned5 = ", owned5.borrow());

  // The adopt function can be used to provide a new value for
  ...
  writeln("after owned1.adopt C(100)");
  writeln("owned1 = ", owned1.borrow());

  // The release function can be used to extract the
