 ...
 *
 *  This example implements a generic stack data structure and then
 *  instantiates the generic stack over strings and tuples of integers
 *  as examples of how to use the class.  This generic stack
