/*
Test a **generic** record implementing an interface:
* the implements-statement is inferred implicitly
* interfaces do not have associated types
* the records have generic 'var' and 'param' fields and 'type' field or method

Note: while IFC1 and IFC2 are numbered, reqFun and cgFun are not.
This way we are checking some overloading, even if trivally-resolvable.
*/
...
//inferred: implements IFC2(MyRec, NotherRec);
