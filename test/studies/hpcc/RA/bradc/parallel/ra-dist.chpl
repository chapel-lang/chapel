...
def main() {
  ...
  const TableDist = new dist(new Block(rank=1, idxType=indexType, bbox=[0..m-1], targetLocales=Locales)),
       UpdateDist = new dist(new Block(rank=1, idxType=indexType, bbox=[0..N_U-1], targetLocales=Locales));
