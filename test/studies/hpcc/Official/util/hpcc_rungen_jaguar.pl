...
aprun -n $ncpus -N 4 ../hpcc-CrayXT-hpcc08
cat hpccoutf.txt
mv -f hpccoutf.txt hpccoutf.hpcc-CrayXT-hpcc08.txt.`date -Iseconds`

../chpl-stream-fragforall -nl $sizeparam

../chpl-stream-fragfrag -nl $sizeparam --tasksPerLocale=1
../chpl-stream-fragfrag -nl $sizeparam --tasksPerLocale=2
../chpl-stream-fragfrag -nl $sizeparam --tasksPerLocale=3
../chpl-stream-fragfrag -nl $sizeparam --tasksPerLocale=4
../chpl-stream-fragfrag -nl $sizeparam --tasksPerLocale=5
