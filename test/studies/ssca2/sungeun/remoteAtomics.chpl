module remoteAtomics {
  ...
  record ratomicflag {
    ...
    inline proc exchange(value:bool):bool {
      var ret:int(64);
      var v = value:int(64);
      chpl_comm_atomic_xchg_int64(v, this.locale.id:int(32), this._v, ret, LINENO, "remoteAtomics.chpl");
      return ret:bool;
    }
  ...
  record ratomic_real64 {
    ...
    inline proc exchange(value:real(64)):real(64) {
      var ret:real(64);
      var v = value;
      chpl_comm_atomic_xchg_real64(v, this.locale.id:int(32), this._v, ret, LINENO, "remoteAtomics.chpl");
      return ret;
    }
    inline proc compareExchange(expected:real(64), desired:real(64)):bool {
      ...
      var te = expected;
      var td = desired;
      chpl_comm_atomic_cmpxchg_real64(te, td, this.locale.id:int(32), this._v, ret, LINENO, "remoteAtomics.chpl");
      return ret;
    }
