...
class AMRSolution {
  ...
  var coarse_interfaces: [hierarchy.level_indices] CFSolutionInterface;
  var fine_interfaces:   [hierarchy.level_indices] CFSolutionInterface;

  def time {
    return level_solutions(1).current_time;
  }
