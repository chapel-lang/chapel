module block_1D_outer_product_cholesky {
  ...
  proc block_1D_outer_product_cholesky ( A : [] )
    ...
    for ( A11_rc_indices, A22_rc_indices ) in
	...
	transposed_block_triangular_solve (A (A11_rc_indices, A11_rc_indices), 
	...
	symmetric_block_schur_complement ( A (A22_rc_indices, A22_rc_indices),  
					   A (A22_rc_indices, A11_rc_indices) );
