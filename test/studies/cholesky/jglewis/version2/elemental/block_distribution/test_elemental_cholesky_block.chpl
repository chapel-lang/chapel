module cholesky_test_elemental_symmetric_ranges {
  ...
  // |                                                                        |
  // |  SPECIAL DEMONSTRATION VERSION USING BLOCK DISTRIBUTION INSTEAD OF     |
  // |  CYCLIC DISTRIBUTION.                                                  |
  // |                                                                        |
  // |  Demonstrates ease of changing distributions while preserving          |
  // |  correctness of algorithms, but all locality assumption are off        |
  // |  in this version!                                                      |
  // +------------------------------------------------------------------------+
