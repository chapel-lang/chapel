module elemental_cholesky_symmetric_index_ranges_block {

  // SPECIAL VERSION USING BLOCK DISTRIBUTION INSTEAD OF CYCLIC DISTRIBUTION
  // ALL LOCALITY ASSUMPTIONS ARE VOID!
  ...
  def elemental_cholesky_symmetric_index_ranges ( A : [] )
    ...
    const A_locale_grid = A.domain.dist._value.targetLocales; // block version
