module elemental_cholesky_symmetric_index_ranges_alt {
  ...
  proc elemental_cholesky_symmetric_index_ranges_alt ( A : [] )
	...
	for ( A11_cols, A22_cols,
		my_A1x_rows, my_Ax1_cols,  
		my_A2x_rows, my_Ax2_cols,
		I_compute_L21_rows ) in
	  local_reduced_matrix_cyclic_partition_alt ( A_idx_range, processor,
						      r, c ) 
	  do {
