module cholesky_scalar_algorithms {
  ...
  def scalar_row_major_outer_product_cholesky ( A : [] )
  ...
  def scalar_row_major_outer_product_no_vector_cholesky ( A : [] )
  ...
  def scalar_row_major_bounded_outer_product_cholesky ( A : [] )
  ...
  def scalar_row_major_temp_outer_product_cholesky ( A : [] )
  ...
  def scalar_column_major_outer_product_cholesky ( A : [] )
