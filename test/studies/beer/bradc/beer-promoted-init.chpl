...
// array of lyrics, initialized and computed in parallel
var Lyrics: [LyricsSpace] string = computeLyric(LyricsSpace);
...
proc computeLyric(verseNum: int) {
...
proc describeBottles(bottleNum, startOfVerse = false) {
  // FIXME: Go back to the original string cast.
