...
void __alignLow_679219(_ref_range_int32_t_bounded_0 _this_679224, int32_t alignment) {
  ...
  T11 = (T10!=0);
  if (T11) {
    T12 = ((*_this_679224)._low);
    T13 = (T12-alignment);
    T14 = (T13<0);
    if (T14) {
      T15 = ((*_this_679224)._low);
      T16 = (T15+T10);
      (*_this_679224)._low = T16;
    } else {
      T17 = (T4-T10);
      T18 = ((*_this_679224)._low);
      T19 = (T18+T17);
      (*_this_679224)._low = T19;
    }
  }
  return;
}
...
void __alignLow_689507(_ref_range_int64_t_bounded_0 _this_689512, int64_t alignment, int32_t _ln, _string _fn) {
  ...
  T14 = (T12!=T13);
  if (T14) {
    T15 = ((*_this_689512)._low);
    T16 = (T15-alignment);
    T17 = ((int64_t)(0));
    T18 = (T16<T17);
    if (T18) {
      T19 = ((*_this_689512)._low);
      T20 = (T19+T12);
      (*_this_689512)._low = T20;
    } else {
      T21 = (T5-T12);
      T22 = ((*_this_689512)._low);
      T23 = (T22+T21);
      (*_this_689512)._low = T23;
    }
  }
  return;
}
...
void __alignHigh_689965(_ref_range_int64_t_bounded_0 _this_689970, int64_t alignment, int32_t _ln, _string _fn) {
  ...
  T14 = (T12!=T13);
  if (T14) {
    T15 = ((*_this_689970)._high);
    T16 = (T15-alignment);
    T17 = ((int64_t)(0));
    T18 = (T16>T17);
    if (T18) {
      T19 = ((*_this_689970)._high);
      T20 = (T19-T12);
      (*_this_689970)._high = T20;
    } else {
      T21 = (T5-T12);
      T22 = ((*_this_689970)._high);
      T23 = (T22-T21);
      (*_this_689970)._high = T23;
    }
  }
  return;
}
...
void __alignHigh_679677(_ref_range_int32_t_bounded_0 _this_679682, int32_t alignment) {
  ...
  T11 = (T10!=0);
  if (T11) {
    T12 = ((*_this_679682)._high);
    T13 = (T12-alignment);
    T14 = (T13>0);
    if (T14) {
      T15 = ((*_this_679682)._high);
      T16 = (T15-T10);
      (*_this_679682)._high = T16;
    } else {
      T17 = (T4-T10);
      T18 = ((*_this_679682)._high);
      T19 = (T18-T17);
      (*_this_679682)._high = T19;
    }
  }
  return;
}
...
range_int64_t_bounded_0 _this_687211(_ref_range_int64_t_bounded_0 _this_687216, range_int64_t_bounded_0* const other, int32_t _ln, _string _fn) {
  ...
  T2 = ((*_this_687216)._low);
  T3 = ((*_this_687216)._high);
  T4 = ((*_this_687216)._stride);
  T5 = (T4<0);
  if (T5) {
    T6 = (-T4);
    T7 = T6;
  ...
  T20 = _extendedEuclid_687585(T7, T16);
  T21 = (T20.x1);
  T22 = (T20.x2);
  T23 = (T2>T11);
  if (T23) {
  ...
  if (T39) {
    ...
    T53 = (T10+T52);
    T54 = &(T30);
    __alignLow_689507(T54, T53, _ln, _fn);
    T55 = &(T30);
    __alignHigh_689965(T55, T53, _ln, _fn);
  }
  T56 = T30;
  return T56;
}
...
range_int32_t_bounded_1 _this_634490(_ref_range_int64_t_bounded_0 _this_634495, range_int32_t_bounded_1* const other, int32_t _ln, _string _fn) {
  ...
  T2 = ((*_this_634495)._low);
  T3 = ((int32_t)(T2));
  T4 = ((*_this_634495)._high);
  T5 = ((int32_t)(T4));
  T6 = ((*_this_634495)._stride);
  T7 = (T6<0);
  if (T7) {
    T8 = (-T6);
    T9 = T8;
  ...
  T22 = _extendedEuclid_634864(T9, T18);
  T23 = (T22.x1);
  T24 = (T22.x2);
  T25 = (T3>T13);
  if (T25) {
...
range_int32_t_bounded_0 _this_676631(_ref_range_int32_t_bounded_0 _this_676636, range_int32_t_bounded_0* const other) {
  ...
  T1 = _copy(&((*other)));
  T2 = ((*_this_676636)._low);
  T3 = ((*_this_676636)._high);
  T4 = ((*_this_676636)._stride);
  T5 = (T4<0);
  if (T5) {
    T6 = (-T4);
    T7 = T6;
  ...
  T20 = _extendedEuclid_677005(T7, T16);
  T21 = (T20.x1);
  T22 = (T20.x2);
  T23 = (T2>T11);
  if (T23) {
  ...
  if (T36) {
    ...
    T47 = (T10+T46);
    T48 = &(T30);
    __alignLow_679219(T48, T47);
    T49 = &(T30);
    __alignHigh_679677(T49, T47);
  }
  T50 = T30;
  return T50;
}
