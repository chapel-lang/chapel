...
void _checkOpen(file f, chpl_bool isRead, int32_t _ln, _string _fn) {
  ...
  if (T2) {
    ...
    if (isRead) {
      _halt_666418("***Error: You must open \"", T7, "\" before trying to read from it***", _ln, _fn);
    } else {
      _halt_666418("***Error: You must open \"", T7, "\" before trying to write to it***", _ln, _fn);
    }
  }
  return;
}
...
void writeIt(file _this_18407, _string s, int32_t _ln, _string _fn) {
  ...
  if (T6) {
    ...
    _halt_669176("***Error: ", T7, "/", T8, " not open for writing***", _ln, _fn);
  }
  T9 = (_this_18407->_fp);
  T10 = fprintf(T9, "%s", s);
  T11 = (T10<0);
  if (T11) {
    T12 = get_errno();
    _halt_666418("***Error: Write failed: ", T12, "***", _ln, _fn);
  }
  return;
}
...
void _write_613618(_ref__string _this_613623, int32_t _e0_args, int32_t _ln, _string _fn) {
  ...
  T4 = ((Writer)(T3));
  _write_613677(T4, _e0_args, _ln, _fn);
  T5 = (T3->s);
...
chpl_bool lockWrite(file _this_18623, int32_t _ln, _string _fn) {
  ...
  T9 = __EQUAL__672665(T8, T1, _ln, _fn);
...
void _write_661735(Writer _this_661739, _string _e0_args, _string _e1_args, _string _e2_args, int32_t _ln, _string _fn) {
  ...
  chpl_bool T4;
  file T5 = NULL;
  T1 = (((object)_this_661739)->_cid == _e_file);
  if (T1) {
    T2 = ((file)(_this_661739));
    T3 = lockWrite(T2, _ln, _fn);
  } else {
    T3 = _lockWrite_18710(_this_661739);
  }
  writeThis(_e0_args, _this_661739, _ln, _fn);
  writeThis(_e1_args, _this_661739, _ln, _fn);
  writeThis(_e2_args, _this_661739, _ln, _fn);
  if (T3) {
    T4 = (((object)_this_661739)->_cid == _e_file);
    if (T4) {
      T5 = ((file)(_this_661739));
      unlockWrite(T5);
    } else {
      _unlockWrite_18718(_this_661739);
    }
  }
  return;
}
...
void _write_613677(Writer _this_613681, int32_t _e0_args, int32_t _ln, _string _fn) {
  ...
  chpl_bool T5;
  file T6 = NULL;
  T1 = (((object)_this_613681)->_cid == _e_file);
  if (T1) {
    T2 = ((file)(_this_613681));
    T3 = lockWrite(T2, _ln, _fn);
  } else {
    T3 = _lockWrite_18710(_this_613681);
  }
  T4 = int32_t_to_string(_e0_args);
  writeThis(T4, _this_613681, _ln, _fn);
  if (T3) {
    T5 = (((object)_this_613681)->_cid == _e_file);
    if (T5) {
      T6 = ((file)(_this_613681));
      unlockWrite(T6);
    } else {
      _unlockWrite_18718(_this_613681);
    }
  }
  return;
}
...
void _writeln_661495(Writer _this_661499, _string _e0_args, _string _e1_args, int32_t _ln, _string _fn) {
  _write_661735(_this_661499, _e0_args, _e1_args, "\n", _ln, _fn);
  return;
}
...
void _writeln_661293(_string _e0_args, _string _e1_args, int32_t _ln, _string _fn) {
  Writer T1 = NULL;
  T1 = ((Writer)(_stdout_16871));
  _writeln_661495(T1, _e0_args, _e1_args, _ln, _fn);
  return;
}
...
void _halt_612944(_string _e0_args, int32_t _e1_args, _string _e2_args, int32_t _ln, _string _fn) {
  ...
  T1.x2 = _e1_args;
  T1.x3 = _e2_args;
  T2 = __tuple2string_613165(&(T1), _ln, _fn);
...
void _halt_669176(_string _e0_args, _string _e1_args, _string _e2_args, _string _e3_args, _string _e4_args, int32_t _ln, _string _fn) {
  ...
  T1.x4 = _e3_args;
  T1.x5 = _e4_args;
  T2 = __tuple2string_669665(&(T1), _ln, _fn);
  T3 = string_concat("halt reached - ", T2, _ln, _fn);
  chpl_error(T3, _ln, _fn);
  return;
}
...
void _halt_666418(_string _e0_args, _string _e1_args, _string _e2_args, int32_t _ln, _string _fn) {
  ...
  T1.x2 = _e1_args;
  T1.x3 = _e2_args;
  T2 = __tuple2string_666497(&(T1), _ln, _fn);
  T3 = string_concat("halt reached - ", T2, _ln, _fn);
  chpl_error(T3, _ln, _fn);
  return;
}
