...
record body {
  var pos: 3*real;
  // var filler: real;  // TODO: some reference versions use this dummy field to pad things
  var v: 3*real;
  const mass: real;
}
...
//
// a utility routine to compute the sum of squares of a tuple's components
//
