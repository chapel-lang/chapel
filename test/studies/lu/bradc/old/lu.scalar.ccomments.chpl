...
const MatDom: domain(2) = [1..numRows, 1..numCols] dmapped new cyclicDist(2);
...
for d in 1..numDiags {
  ...
  const TopRow: subdomain(Reduced) = [d, d..numCols];
  ...
  const PivotRow: subdomain(Reduced) = [pivotLoc(1), d..numCols];
