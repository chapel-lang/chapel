...
const BlockD: domain(1) dmapped new Block(rank=1,boundingBox=bbox) = aSpace;
const BlockmaxD: domain(1) dmapped new Block(rank=1,boundingBox=bbox) = maxSpace;
const BlockminD: domain(1) dmapped new Block(rank=1,boundingBox=bbox) = minSpace;
