...
const BlockD: domain(1) distributed new dist(new Block(rank=1,bbox=bbox)) = aSpace;
const BlockmaxD: domain(1) distributed new dist(new Block(rank=1,bbox=bbox)) = maxSpace;
const BlockminD: domain(1) distributed new dist(new Block(rank=1,bbox=bbox)) = minSpace;
