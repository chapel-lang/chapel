//
// Histogram: parallel reduce example
//
// Computes the histogram of an array of random numbers.
//
// Oct 7, 2023: copied from chapel/test/exercises/histogram1.chpl and made slite changes
...
proc computeHistogram(X: [] real, ref histogram: [] int) {
  forall x in X with (+ reduce histogram) do
