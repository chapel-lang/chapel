...
static void setupSearchPaths(Context* ctx, bool enableStdLib,
  ...
  if (enableStdLib) {
    ...
    setupModuleSearchPaths(ctx,
                           chpl_home,
                           false,
                           getChplEnvEntry(ctx, "CHPL_LOCALE_MODEL"),
                           false,
                           getChplEnvEntry(ctx, "CHPL_TASKS"),
                           getChplEnvEntry(ctx, "CHPL_COMM"),
                           getChplEnvEntry(ctx, "CHPL_SYS_MODULES_SUBDIR"),
                           getChplEnvEntry(ctx, "CHPL_MODULE_PATH"),
                           cmdLinePaths,
                           files);
  } else {
