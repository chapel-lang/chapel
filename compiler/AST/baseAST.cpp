...
void printStatistics(const char* pass) {
  ...
  int nType = nPrimitiveType+nEnumType+nAggregateType+nManagedClassType;
  int kType = kPrimitiveType+kEnumType+kAggregateType+kManagedClassType;
