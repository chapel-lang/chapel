...
initPrimitive() {
  ...
  prim_def("cbrt", cbrt_interpreter_op, return_float_analysis_op);
  ...
  prim_def("expm1", expm1_interpreter_op, return_float_analysis_op);
  prim_def("fabs", fabs_interpreter_op, return_float_analysis_op);
  prim_def("floor", floor_interpreter_op, return_float_analysis_op);
  prim_def("lgamma", lgamma_interpreter_op, return_float_analysis_op);
  prim_def("log", log_interpreter_op, return_float_analysis_op);
  prim_def("log2", log2_interpreter_op, return_float_analysis_op);
  prim_def("log10", log10_interpreter_op, return_float_analysis_op);
  prim_def("log1p", log1p_interpreter_op, return_float_analysis_op);
  prim_def("nearbyint", nearbyint_interpreter_op, return_float_analysis_op);
  prim_def("rint", rint_interpreter_op, return_float_analysis_op);
  prim_def("round", round_interpreter_op, return_float_analysis_op);
  prim_def("sin", sin_interpreter_op, return_float_analysis_op);
  prim_def("sinh", sinh_interpreter_op, return_float_analysis_op);
  prim_def("sqrt", sqrt_interpreter_op, return_float_analysis_op);
  prim_def("tan", tan_interpreter_op, return_float_analysis_op);
  prim_def("tanh", tanh_interpreter_op, return_float_analysis_op);
  prim_def("tgamma", tgamma_interpreter_op, return_float_analysis_op);
  prim_def("trunc", trunc_interpreter_op, return_float_analysis_op);
  ...
  prim_def(PRIMITIVE_GET_MEMBER_REF_TO, ".*", unimplemented_interpreter_op, unimplemented_analysis_op);
  prim_def(PRIMITIVE_SET_MEMBER_REF_TO, ".=&", unimplemented_interpreter_op, unimplemented_analysis_op);
