...
static void updateConstructor(FnSymbol* fn) {
  ...
  ModuleSymbol* mod = fn->getModule();
  if (strcmp(mod->name, "String") &&
      strcmp(mod->name, "OwnedObject") &&
      strcmp(mod->name, "BlockDim") &&
      strcmp(mod->name, "DefaultRectangular") &&
      strcmp(mod->name, "DefaultAssociative") &&
      strcmp(mod->name, "DefaultSparse") &&
      strcmp(mod->name, "DefaultOpaque") &&
      strcmp(mod->name, "BlockDist") &&
      strcmp(mod->name, "CyclicDist") &&
      strcmp(mod->name, "BlockCycDist") &&
      strcmp(mod->name, "SparseBlockDist") &&
      strcmp(mod->name, "LayoutCS") &&
      strcmp(mod->name, "DimensionalDist2D") &&
      strcmp(mod->name, "StencilDist") &&
      strcmp(mod->name, "ReplicatedDist")
      ) {
