...
struct ConvertTypeHelper {
  ...
  Type* visit(const types::BasicClassType* bct) {
    auto& rfds = fieldsForTypeDecl(context(), bct, DefaultsPolicy::USE_DEFAULTS);
  ...
  Type* visit(const types::RecordType* t) {
    auto& rfds = fieldsForTypeDecl(context(), t, DefaultsPolicy::USE_DEFAULTS);
...
locateFieldSymbolAndType(TConverter* tc,
  ...
  auto& rfds = fieldsForTypeDecl(tc->context, ct, dpo);
