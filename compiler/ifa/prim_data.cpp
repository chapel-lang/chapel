...
void prim_init(Primitives *p, IF1 *if1) {
  ...
  prim_reply = new Prim(33, "reply", "prim_reply", -3, 0, 1, prim_reply_arg_types, prim_reply_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_tuple = new Prim(34, "make_tuple", "prim_tuple", -2, 0, 1, prim_tuple_arg_types, prim_tuple_ret_types, 0);
  ...
  prim_vector = new Prim(35, "make_vector", "prim_vector", -2, 0, 1, prim_vector_arg_types, prim_vector_ret_types, 0);
  ...
  prim_continuation = new Prim(36, "make_continuation", "prim_continuation", -2, 0, 1, prim_continuation_arg_types, prim_continuation_ret_types, 0);
  ...
  prim_new = new Prim(37, "new", "prim_new", -2, 0, 1, prim_new_arg_types, prim_new_ret_types, 0);
  ...
  prim_index_object = new Prim(38, "index_object", "prim_index_object", -3, 0, 1, prim_index_object_arg_types, prim_index_object_ret_types, 0);
  ...
  prim_set_index_object = new Prim(39, "set_index_object", "prim_set_index_object", -4, 0, 1, prim_set_index_object_arg_types, prim_set_index_object_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_meta_apply = new Prim(40, "meta_apply", "prim_meta_apply", 3, 0, 1, prim_meta_apply_arg_types, prim_meta_apply_ret_types, 0);
  ...
  prim_destruct = new Prim(41, "destruct", "prim_destruct", 2, 0, 1, prim_destruct_arg_types, prim_destruct_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_set = new Prim(42, "make_set", "prim_set", -2, 0, 1, prim_set_arg_types, prim_set_ret_types, 0);
  ...
  prim_list = new Prim(43, "make_list", "prim_list", -2, 0, 1, prim_list_arg_types, prim_list_ret_types, 0);
  ...
  prim_coerce = new Prim(44, "coerce", "prim_coerce", -3, 0, 1, prim_coerce_arg_types, prim_coerce_ret_types, 0);
  ...
  prim_primitive = new Prim(45, "primitive", "prim_primitive", -2, 0, -1, prim_primitive_arg_types, prim_primitive_ret_types, PRIM_NON_FUNCTIONAL);
