...
enum IF1_const_kind {
  IF1_CONST_KIND_STRING = NUM_KIND_COMPLEX + 1, IF1_CONST_KIND_SYMBOL
};

enum IF1_int_type { 
  INT_TYPE_1, INT_TYPE_8, INT_TYPE_16, INT_TYPE_32, INT_TYPE_64,
  INT_TYPE_NUM
};

enum IF1_float_type { 
  FLOAT_TYPE_16, FLOAT_TYPE_32, FLOAT_TYPE_48, FLOAT_TYPE_64, 
  FLOAT_TYPE_80, FLOAT_TYPE_96, FLOAT_TYPE_112, FLOAT_TYPE_128, 
  FLOAT_TYPE_NUM
};
...
class Immediate : public gc { public:
  ...
  void set_int(int64 l, IF1_int_type int_type=INT_TYPE_64) {
    const_kind = NUM_KIND_INT;
    num_index = int_type;
    switch( int_type) {
    case INT_TYPE_8:  v_int8  = l; break;
    case INT_TYPE_16: v_int16 = l; break;
    case INT_TYPE_32: v_int32 = l; break;
    case INT_TYPE_64: v_int64 = l; break;
    default:
      assert(!"unsupported int IF1_int_type");
    }
  }

  void set_uint(uint64 ul, IF1_int_type uint_type=INT_TYPE_64) {
    const_kind = NUM_KIND_UINT;
    num_index = uint_type;
    switch( uint_type) {
    case INT_TYPE_8:  v_uint8  = ul; break;
    case INT_TYPE_16: v_uint16 = ul; break;
    case INT_TYPE_32: v_uint32 = ul; break;
    case INT_TYPE_64: v_uint64 = ul; break;
    default:
      assert(!"unsupported uint IF1_int_type");
    }
  }

  void set_float(float128 f, IF1_float_type fp_type=FLOAT_TYPE_64) {
    const_kind = NUM_KIND_FLOAT;
    num_index = fp_type;
    switch( fp_type) {
    case FLOAT_TYPE_32:  v_float32 = f;  break;
    case FLOAT_TYPE_64:  v_float64 = f;  break;
    case FLOAT_TYPE_128: v_float128 = f; break;
    default:
...
Immediate::int_value( void) {
  int64 val;
  switch (num_index) {
  case INT_TYPE_8 : val = v_int8;  break;
  case INT_TYPE_16: val = v_int16; break;
  case INT_TYPE_32: val = v_int32; break;
  case INT_TYPE_64: val = v_int64; break;
  default:
...
Immediate::uint_value( void) {
  uint64 val;
  switch (num_index) {
  case INT_TYPE_1 : val = v_bool;  break;
  case INT_TYPE_8 : val = v_uint8;  break;
  case INT_TYPE_16: val = v_uint16; break;
  case INT_TYPE_32: val = v_uint32; break;
  case INT_TYPE_64: val = v_uint64; break;
  default:
