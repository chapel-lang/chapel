...
//
// Noakes 2017/03/04, updated 2018/03
//
...
//
//   move _str_literal_NNN, ret_tmp;   // This is the single def
//
static void removeDeadStringLiteral(DefExpr* defExpr) {
  ...
  INT_ASSERT(isDefExpr (stmt1));   // var  call_tmp
  INT_ASSERT(isCallExpr(stmt2));   // move call_tmp, cast(..)
  INT_ASSERT(isDefExpr (stmt3));   // var  ret_tmp
  INT_ASSERT(isCallExpr(stmt4));   // _construct_string(..)
  INT_ASSERT(isCallExpr(stmt5));   // move _str_literal_NNN, ret_tmp
