...
static ArgumentDescription arg_desc[] = {
 ...
 {"target-codelet", ' ', NULL, "Enable [disable] the targeting of the codelet programming model", "N", &fTargetCodelet, "CHPL_DISABLE_INTERVALS", NULL},
