...
const char* CHPL_TARGET_STATIC_RUNTIME_LIB_PATH = NULL;
const char* CHPL_TARGET_SHARED_RUNTIME_LIB_PATH = NULL;
...
static void setChapelEnvs() {
  ...
  CHPL_TARGET_STATIC_RUNTIME_LIB_PATH = envMap["CHPL_TARGET_STATIC_RUNTIME_LIB_PATH"];
  CHPL_TARGET_SHARED_RUNTIME_LIB_PATH = envMap["CHPL_TARGET_SHARED_RUNTIME_LIB_PATH"];
