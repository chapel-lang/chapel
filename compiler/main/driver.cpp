...
static ArgumentDescription arg_desc[] = {
 ...
 {"savec", ' ', "<path>", "Save generated C code in directory", "P", saveCDir, "CHPL_SAVEC_DIR", NULL},

 {"", ' ', NULL, "Linker Control", NULL, NULL, NULL, NULL},
 {"ccflags", ' ', "<flags>", "Back-end C compiler flags", "S256", ccflags, "CHPL_CC_FLAGS", NULL},
 {"lib-linkage", 'l', "<path>", "C library linkage", "P", libraryFilename, "CHPL_LIB_NAME", handleLibrary},
 {"lib-search-path", 'L', "<path>", "C library search path", "P", libraryFilename, "CHPL_LIB_PATH", handleLibPath},
 {"output", 'o', "<name>", "Name output executable", "P", executableFilename, "CHPL_EXE_NAME", NULL},

 {"", ' ', NULL, "Miscellaneous Flags", NULL, NULL, NULL, NULL},
 {"chplhome", ' ', "<path>", "Over-ride $CHPL_HOME", "P", chplhome, "CHPL_HOME", NULL},
