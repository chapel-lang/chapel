...
#ifdef _MSC_VER
#define MSC_SETUP_ENV_VAR(varname, val) \
  { \
    parseCmdLineConfig(#varname, astr("\"", val, "\"")); \
    varname = val; \
  } 
...
#ifdef _MSC_VER
  MSC_SETUP_ENV_VAR(CHPL_HOST_PLATFORM, "cygwin");
  MSC_SETUP_ENV_VAR(CHPL_TARGET_PLATFORM, "cygwin");
  MSC_SETUP_ENV_VAR(CHPL_HOST_COMPILER, "gnu");
  MSC_SETUP_ENV_VAR(CHPL_TARGET_COMPILER, "gnu");
  MSC_SETUP_ENV_VAR(CHPL_TASKS, "none");
  MSC_SETUP_ENV_VAR(CHPL_THREADS, "none");
  MSC_SETUP_ENV_VAR(CHPL_COMM, "none");
  MSC_SETUP_ENV_VAR(CHPL_COMM_SUBSTRATE, "none");
  MSC_SETUP_ENV_VAR(CHPL_GASNET_SEGMENT, "none");
  MSC_SETUP_ENV_VAR(CHPL_ATOMICS, "none");
  MSC_SETUP_ENV_VAR(CHPL_NETWORK_ATOMICS, "none");
  MSC_SETUP_ENV_VAR(CHPL_GMP, "none");
  MSC_SETUP_ENV_VAR(CHPL_MAKE, "make");
#else
...
#ifdef _MSC_VER
      char *targ = new char[strlen(argv[i])+4];
#else
