...
// {"log-symbol", ' ', "<symbol-name>", "Restrict IR dump to the named symbol(s)", "S256", log_symbol, "CHPL_LOG_SYMBOL", NULL}, // This doesn't work yet.
 ...
 {"gpu-specialization", ' ', NULL, "Enable [disable] an optimization that clones functions known to executed on a GPU locale", "N", &fGpuSpecialization, "CHPL_GPU_SPECIALIZATION", NULL},
