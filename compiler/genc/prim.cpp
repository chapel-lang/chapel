//
//    PRIM.CPP -- Code generator (C back-end)
//
...
// implementation: primitive expressions
  ...
  GenRet GenC::primUnknown(CallExpr *self) {
      return codegenBasicPrimitiveExpr(self);
      }
      
  void GenC::primArraySet(CallExpr *self) {
  ...
  void GenC::primArrayAlloc(CallExpr *self) {
      Expr *a1 = self->get(1);
      GenRet dst = eval(a1);
      GenRet alloced;
  ...
  void GenC::primGpuAlloc(CallExpr *self) {
      Expr *a1 = self->get(1);
      if (hasFlag(a1, FLAG_WIDE_CLASS))
          codegenCall(
              "_GPU_ALLOC",
  ...
  void GenC::primCopyHostGpu(CallExpr *self) {
      codegenCall(
          "_GPU_COPY_HOST_GPU", 
          evalArg(self, 1), 
          evalArg(self, 2), 
  ...
  void GenC::primCopyGpuHost(CallExpr *self) {
      codegenCall(
          "_GPU_COPY_GPU_HOST", 
          evalArg(self, 1), 
          evalArg(self, 2), 
  ...
  void GenC::primGpuFree(CallExpr *self) {
      if (fNoMemoryFrees)
          return;
      codegenCall("_GPU_FREE", evalArg(self, 1));
      }
      
  void GenC::primArrayFree(CallExpr *self) {
      if (fNoMemoryFrees)
          return;
      Expr *a1 = self->get(1);
      GenRet data = eval(a1);
  ...
  void GenC::primArrayFreeElts(CallExpr *self) {
      if (fNoMemoryFrees)
          return;
  ...
  GenRet GenC::primMove(CallExpr *self) {
      GenRet ret;
  ...
  GenRet GenC::primAddrOf(CallExpr *self) {
      return codegenAddrOf(evalArg(self, 1));
      }
      
  GenRet GenC::primRefToString(CallExpr *self) {
      GenRet ret;
      Expr *a1 = self->get(1);
  ...
  GenRet GenC::primReturn(CallExpr *self) {
      GenRet ret;
  ...
  GenRet GenC::primUnaryMinus(CallExpr *self) {
      return codegenNeg(evalArg(self, 1));
      }
      
  GenRet GenC::primUnaryPlus(CallExpr *self) {
      GenRet ret;
  ...
  GenRet GenC::primUnaryNot(CallExpr *self) {
      GenRet ret;
      GenRet tmp = codegenValue(evalArg(self, 1));
      ret.c = "(~ " + tmp.c + ")";
      return ret;
  ...
  GenRet GenC::primUnaryLnot(CallExpr *self) {
      return codegenIsZero(evalArg(self, 1));
      }
      
  GenRet GenC::primAdd(CallExpr *self) {
      return codegenAdd(evalArg(self, 1), evalArg(self, 2));
      }
      
  GenRet GenC::primSubtract(CallExpr *self) {
      return codegenSub(evalArg(self, 1), evalArg(self, 2));
      }
      
  GenRet GenC::primMult(CallExpr *self) {
      return codegenMul(evalArg(self, 1), evalArg(self, 2));
      }
      
  GenRet GenC::primDiv(CallExpr *self) {
      GenRet ret;
  ...
  GenRet GenC::primMod(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " % " + b.c + ")";
  ...
  GenRet GenC::primLsh(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " << " + b.c + ")";
  ...
  GenRet GenC::primRsh(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " >> " + b.c + ")";
  ...
  GenRet GenC::primEqual(CallExpr *self) {
      GenRet ret;
      Expr *a1 = self->get(1);
      Expr *a2 = self->get(2);
  ...
  GenRet GenC::primNotequal(CallExpr *self) {
      GenRet ret;
      Expr *a1 = self->get(1);
      Expr *a2 = self->get(2);
    // TODO: Need subloc field as well.
  ...
  GenRet GenC::primLessorequal(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " <= " + b.c + ")";
  ...
  GenRet GenC::primGreaterorequal(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " >= " + b.c + ")";
  ...
  GenRet GenC::primLess(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " < " + b.c + ")";
  ...
  GenRet GenC::primGreater(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " > " + b.c + ")";
  ...
  GenRet GenC::primAnd(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " & " + b.c + ")";
  ...
  GenRet GenC::primOr(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " | " + b.c + ")";
  ...
  GenRet GenC::primXor(CallExpr *self) {
      GenRet ret;
      GenRet a = codegenValue(evalArg(self, 1));
      GenRet b = codegenValue(evalArg(self, 2));
      ret.c = "(" + a.c + " ^ " + b.c + ")";
  ...
  GenRet GenC::primPow(CallExpr *self) {
      return codegenCallExpr("pow", evalArg(self, 1), evalArg(self, 2));
      }

  GenRet GenC::primMin(CallExpr *self) {
      GenRet ret;
  ...
  GenRet GenC::primMax(CallExpr *self) {
      GenRet ret;
      Type *t = self->get(1)->typeInfo();
      if (is_arithmetic_type(t)) {
          int w = get_width(t);
  ...
  void GenC::primSetcid(CallExpr *self) {
    // get(1) is the object 
    // (type=chpl__class_id,
  ...
  GenRet GenC::primGetcid(CallExpr *self) {
      Expr *a1 = self->get(1);
  ...
  GenRet GenC::primTestcid(CallExpr *self) {
  ...
  void GenC::primSetUnionId(CallExpr *self) {
    // get(1)->_uid = get(2)
      GenRet ref = codegenFieldUidPtr(evalArg(self, 1));
      codegenAssign(ref, evalArg(self, 2));
      }
      
  GenRet GenC::primGetUnionId(CallExpr *self) {
    // returns uid from AP(1)
      GenRet ref = codegenFieldUidPtr(evalArg(self, 1));
      return codegenValue(ref);
      }
      
  void GenC::primSetSvecMember(CallExpr *self) {
  ...
  GenRet GenC::primGetMember(CallExpr *self) {
  ...
  GenRet GenC::primGetSvecMember(CallExpr *self) {
  ...
  void GenC::primSetMember(CallExpr *self) {
  ...
  void GenC::primCheckNil(CallExpr *self) {
      Expr *a1 = self->get(1);
      GenRet ptr = eval(a1);
      if (hasFlag(a1, FLAG_WIDE_CLASS))
  ...
  void GenC::primLocalCheck(CallExpr *self) {
  ...
  void GenC::primSyncInit(CallExpr *self) {
      GenRet fieldPtr = 
          codegenLocalAddrOf(
  ...
  void GenC::primSyncLock(CallExpr *self) {
      codegenCall(
          "chpl_sync_lock",
          codegenLocalAddrOf(
              codegenFieldPtr(evalArg(self, 1), "sync_aux")));
  ...
  void GenC::primSyncUnlock(CallExpr *self) {
      codegenCall(
          "chpl_sync_unlock", 
          codegenLocalAddrOf(
              codegenFieldPtr(evalArg(self, 1), "sync_aux")));
  ...
  void GenC::primSyncWaitFull(CallExpr *self) {
  ...
  void GenC::primSyncWaitEmpty(CallExpr *self) {
    // sync var, lineno, filename
      codegenCall(
  ...
  void GenC::primSyncSignalFull(CallExpr *self) {
      codegenCall(
  ...
  void GenC::primSyncSignalEmpty(CallExpr *self) {
      codegenCall(
  ...
  void GenC::primSingleInit(CallExpr *self) {
      const char *fn =
  ...
  void GenC::primSingleLock(CallExpr *self) {
      codegenCall(
          "chpl_single_lock",
          codegenLocalAddrOf(
              codegenFieldPtr(evalArg(self, 1), "single_aux")));
  ...
  void GenC::primSingleUnlock(CallExpr *self) {
      codegenCall(
          "chpl_single_unlock",
          codegenLocalAddrOf(
              codegenFieldPtr(evalArg(self, 1), "single_aux")));
  ...
  void GenC::primSingleWaitFull(CallExpr *self) {
  ...
  void GenC::primSingleSignalFull(CallExpr *self) {
      codegenCall(
  ...
  void GenC::primWriteef(CallExpr *self) {
  ...
  void GenC::primWriteff(CallExpr *self) {
      const char *fn;
  ...
  void GenC::primSyncReset(CallExpr *self) {
  ...
  GenRet GenC::primReadfe(CallExpr *self) {
      const char *fn;
  ...
  GenRet GenC::primSyncIsFull(CallExpr *self) {
  ...
  void GenC::primSingleWriteef(CallExpr *self) {
    // get(1) is argument (class, wide or not), get(2) is what to write.
      Expr *a1 = self->get(1);
      GenRet s;
      if (hasFlag(a1, FLAG_WIDE_CLASS))
  ...
  void GenC::primSingleReset(CallExpr *self) {
    // get(1) is argument (class, wide or not)
      Expr *a1 = self->get(1);
      GenRet s;
      if (hasFlag(a1, FLAG_WIDE_CLASS))
  ...
  GenRet GenC::primSingleReadff(CallExpr *self) {
      const char *fn;
  ...
  GenRet GenC::primSingleIsFull(CallExpr *self) {
    // get(1) is sync var, get(2) is isSimpleSyncBaseType(arg)
      GenRet s = evalArg(self, 1);
      GenRet val_ptr = codegenLocalAddrOf(codegenFieldPtr(s, "value"));
  ...
  void GenC::primChplCommGetStrd(CallExpr *self) {
  ...
  GenRet GenC::primChplAlloc(CallExpr *self) {
      GenRet size;
  ...
  void GenC::primChplFree(CallExpr *self) {
      if (fNoMemoryFrees)
          return;
  ...
  GenRet GenC::primCast(CallExpr *self) {
      Expr *a1 = self->get(1);
      Expr *a2 = self->get(2);
  ...
  GenRet GenC::primDynamicCast(CallExpr *self) {
  ...
  GenRet GenC::primNodeId(CallExpr *self) {
      return codegenGetNodeID();
      }
      
  GenRet GenC::primOnLocaleNum(CallExpr *self) {
      GenRet ret;
  ...
  void GenC::primIntError(CallExpr *self) {
      codegenCall(
          "chpl_internal_error",
          evalStr("compiler generated error"));
      }
      
  GenRet GenC::primStringCopy(CallExpr *self) {
      GenRet ret;
      Expr *a1 = self->get(1);
      if (hasFlag(a1, FLAG_WIDE_CLASS)) {
  ...
  GenRet GenC::primRtError(CallExpr *self) {
      return codegenBasicPrimitiveExpr(self);
      }
      
  void GenC::primNewPrivClass(CallExpr *self) {
      Expr *a1 = self->get(1);
      GenRet arg = eval(a1);
      if (hasFlag(a1, FLAG_WIDE_CLASS))
  ...
  GenRet GenC::primNumPrivClasses(CallExpr *self) {
      return codegenCallExpr("chpl_numPrivatizedClasses");
      }
      
  GenRet GenC::primFtableCall(CallExpr *self) {
      Expr *a2 = self->get(2);
      Expr *a3 = self->get(3);
    ...
    // Generate a cast based upon the arguments.
      std::string str = "((void(*)(";
      str += a2->typeInfo()->symbol->cname;
      if (argMustUseCPtr(a2->typeInfo())) 
          str += "*";
      str += ",";
      str += a3->typeInfo()->symbol->cname;
      if (argMustUseCPtr(a3->typeInfo())) 
          str += "*";
  ...
  GenRet GenC::primVmtCall(CallExpr *self) {
      GenRet ptrToFnPtr;
      GenRet index;
      FnSymbol *fn = NULL;
      int startArgs = 3;
      ...
      INT_ASSERT(maxVMT() >= 0);
      GenRet maxVMTConst = evalInt(maxVMT());
  ...
  void GenC::primBlockXmtPragmaNoalias(CallExpr *self) {
  ...
  void GenC::invalidPrim(CallExpr *self) {
      INT_FATAL(
          self, "primitive codegen fail; should it still be in the AST?");
      std::string stmt;
      stmt += "/* ERR ";
      stmt += self->primitive->name;
      stmt += "*/";
      writeStatement(stmt);
      }
...
// implementation: function calls
  ...
  void GenC::genBeginBlock(CallExpr *self, FnSymbol *fn) {
  ...
  void GenC::genCobeginOrCoforallBlock(CallExpr *self, FnSymbol *fn) {
  ...
  void GenC::genOnBlock(CallExpr *self, FnSymbol *fn) {
  ...
  GenRet GenC::genFnCall(CallExpr *self, FnSymbol *fn) {
      GenRet ret;
  
      GenRet base = Expr_codegen(self->baseExpr);

      if (fn->hasFlag(FLAG_GPU_ON))
          base = startCudaCall(self, base);
      ...
      for_formals_actuals(formal, actual, self) {
          ...
          if (fn->hasFlag(FLAG_GPU_ON) && count < 2) {
              count++;
            // do not print nBlocks and numThreadsPerBlock
              continue; 
              }
...
// implementation: GPU
  ...
  GenRet GenC::startCudaCall(CallExpr *self, GenRet base) {
      base.c += "<<<";
      base.c += Expr_codegen(self->get(1)).c;
      base.c += ",";
      base.c += Expr_codegen(self->get(2)).c;
      base.c += ">>>";
      return base;
      }
      
  void GenC::endCudaCall(CallExpr *self) {
      writeStatement("cudaThreadSynchronize();\n");
      writeStatement("cudaError_t err = cudaGetLastError();\n");
      writeStatement("if ( cudaSuccess != err) {");
      writeStatement(
          "fprintf(stderr, \"CUDA error: Kernel "
          "Execution Failed in file <%%s>, line %%i"
          " : %%s.\\n\", __FILE__, __LINE__, "
          "cudaGetErrorString( err) );\n");
      writeStatement("chpl_exit_any(-1);\n");
      writeStatement("}\n");
      }
