...
// but rather in AST/primitive.cpp
  ...
  PRIMITIVE_G(PRIM_GPU_KERNEL_LAUNCH)
  PRIMITIVE_G(PRIM_GPU_KERNEL_LAUNCH_FLAT)
  PRIMITIVE_G(PRIM_GPU_THREADIDX_X)
  PRIMITIVE_G(PRIM_GPU_THREADIDX_Y)
  PRIMITIVE_G(PRIM_GPU_THREADIDX_Z)
  PRIMITIVE_G(PRIM_GPU_BLOCKIDX_X)
  PRIMITIVE_G(PRIM_GPU_BLOCKIDX_Y)
  PRIMITIVE_G(PRIM_GPU_BLOCKIDX_Z)
  PRIMITIVE_G(PRIM_GPU_BLOCKDIM_X)
  PRIMITIVE_G(PRIM_GPU_BLOCKDIM_Y)
  PRIMITIVE_G(PRIM_GPU_BLOCKDIM_Z)
  PRIMITIVE_G(PRIM_GPU_GRIDDIM_X)
  PRIMITIVE_G(PRIM_GPU_GRIDDIM_Y)
  PRIMITIVE_G(PRIM_GPU_GRIDDIM_Z)
  ...
  PRIMITIVE_G(PRIM_GET_REQUESTED_SUBLOC)
