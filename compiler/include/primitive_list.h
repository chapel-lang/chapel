...
// but rather in primitive.cpp
  ...
  PRIMITIVE_G(PRIM_ACTUALS_LIST) 
  PRIMITIVE_G(PRIM_NOOP) 
  PRIMITIVE_G(PRIM_MOVE) 
  
  PRIMITIVE_R(PRIM_INIT) 
  PRIMITIVE_R(PRIM_INIT_FIELD) 
  PRIMITIVE_R(PRIM_INIT_MAYBE_SYNC_SINGLE_FIELD) 
  ...
  PRIMITIVE_G(PRIM_REDUCE_ASSIGN) 
  ...
  PRIMITIVE_G(PRIM_ARRAY_ALLOC) 
  PRIMITIVE_G(PRIM_ARRAY_FREE) 
  ...
  PRIMITIVE_G(PRIM_GET_PRIV_CLASS) 
  ...
  PRIMITIVE_R(PRIM_IS_EXTERN_CLASS_TYPE) 
  ...
  PRIMITIVE_R(PRIM_ENUM_MIN_BITS) 
  PRIMITIVE_R(PRIM_ENUM_IS_SIGNED) 
