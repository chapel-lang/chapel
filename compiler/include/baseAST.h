...
#define AST_CHILDREN_CALL(_a, call, ...)                                \
  ...
  case E_ImplementsExpr:                                                \
    AST_CALL_CHILD(_a, ImplementsExpr, implInterface,call, __VA_ARGS__);\
    AST_CALL_LIST(_a,  ImplementsExpr, implActuals,  call, __VA_ARGS__);\
    break;                                                              \
  case E_IfExpr:                                                        \
  ...
  case E_ImplementsStmt:                                                \
    AST_CALL_CHILD(_a, ImplementsStmt, implExpr, call, __VA_ARGS__);    \
  ...
  case E_FnSymbol:                                                      \
    ...
    AST_CALL_LIST(_a, FnSymbol, constrainedTypes,     call, __VA_ARGS__); \
    AST_CALL_LIST(_a, FnSymbol, interfaceConstraints, call, __VA_ARGS__); \
