...
symbolFlag( FLAG_CODELET, npr, "codelet function" , "marker to specify a codelet function")
...
symbolFlag( FLAG_OLD_EXTERN_KW_USED, npr, "old-extern-used", "The old _extern keyword was used" )
...
symbolFlag( FLAG_WHILE_INDEX, ypr, "while index", "way to capture index of while loop")
