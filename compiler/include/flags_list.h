...
symbolFlag( FLAG_ASSIGN_FROM_CONST, npr, "= from const", "assign from const rhs is available" )
symbolFlag( FLAG_ASSIGN_FROM_REF, npr, "= from ref", "assign from ref rhs is available" )
...
symbolFlag( FLAG_INIT_EQUAL_FROM_CONST,  npr, "init= from const" , "init= with const other argument is available" )
symbolFlag( FLAG_INIT_EQUAL_FROM_REF,  npr, "init= from ref" , "init= with ref other argument is available" )
...
symbolFlag( FLAG_NO_ASSIGN , npr, "no =", "Type has no assign overload")
...
symbolFlag( FLAG_NO_INIT_EQUAL , npr, "no init=", "Type has no init=" )
