...
symbolFlag( FLAG_AUTO_SERIALIZE_SIZE,  npr, "auto serialize size fn" , "auto serialize size function" )
symbolFlag( FLAG_AUTO_SERIALIZE,  npr, "auto serialize fn" , "auto serialize function" )
symbolFlag( FLAG_AUTO_DESERIALIZE,  npr, "auto deserialize fn" , "auto deserialize function" )
...
// The value returned by this function is not "owned", so the caller should not call the destructor on it.
symbolFlag( FLAG_RETURN_VALUE_IS_NOT_OWNED , ypr, "return value is not owned", ncm )
