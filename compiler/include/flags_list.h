...
symbolFlag( FLAG_RETURN_SCOPE, ypr, "return scope", "indicates an argument that can be returned without error in lifetime checking")
...
symbolFlag( FLAG_SCOPE, ypr, "scope", "scoped (lifetime checking like a local variable)")
