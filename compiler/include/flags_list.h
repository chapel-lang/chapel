...
symbolFlag( FLAG_CCACHE, ypr, "constant cache array", "marker to specify constant cache array for GPU")
...
symbolFlag( FLAG_CONST_MEM_SIZE, ypr, "ccmem", "specify constant cache size for GPU")
...
symbolFlag( FLAG_EXPLICIT_GPU_ARRAY, ypr, "explicit gpu array", "marker to designate gpu data")
...
symbolFlag( FLAG_GEN_SHARED, ypr, "gen shared", "marker to generate shared mem decl for the GPU" )
symbolFlag( FLAG_GEN_CC, ypr, "gen cc", "marker to generate constant cache mem for the GPU" )
...
symbolFlag( FLAG_IMPLICIT_GPU_ARRAY, ypr, "implicit gpu array", "marker to designate implicit gpu data movement")
symbolFlag( FLAG_INDEX_VAR , npr, "index var" , ncm )
symbolFlag( FLAG_INLINE , ypr, "inline" , ncm )
symbolFlag( FLAG_INLINE_ITERATOR , ypr, "inline iterator" , "iterators that are always inlined, e.g., leaders" )
...
symbolFlag( FLAG_PROC_ITER_KW_USED, npr, "proc-iter-used", "was the 'proc' or 'iter' keyword used when declaring this function" )
symbolFlag( FLAG_PROMOTION_WRAPPER , npr, "promotion wrapper" , ncm )
symbolFlag( FLAG_RANGE , ypr, "range" , ncm )
symbolFlag( FLAG_REDUCE, ypr, "reduce", "mark a function as a GPU reduction")
...
symbolFlag( FLAG_SHARED, ypr, "shared array", "shared mem for GPU")
...
symbolFlag( FLAG_USE_GPU_REDUCTION, ypr, "use gpu reduction", "use specialized GPU implementation" )
