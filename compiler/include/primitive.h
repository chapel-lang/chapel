...
enum PrimitiveTag {
  ...
  PRIM_GPU_GET_VALUE,
  PRIM_GPU_GET_VAL,
  PRIM_GPU_COPY_ARRAY_TO_CONST_MEM,
  PRIM_GPU_COPY_SCALAR_TO_CONST_MEM,
  PRIM_GPU_COPY_TO_CONST_MEM_EXPL,
  PRIM_GPU_ALLOC,
  PRIM_COPY_HOST_GPU,
  PRIM_COPY_GPU_HOST,
  PRIM_COPY_HOST_HOST,
  PRIM_COPY_GPU_GPU,
  PRIM_DECLARE_CONSTANT_MEM,
  PRIM_GPU_FREE,
  PRIM_ON_GPU,
  PRIM_CALL_GPU,
  PRIM_GPU_REDUCE,
  PRIM_IMPLICIT_COPY_HOST_GPU,
  PRIM_IMPLICIT_COPY_GPU_HOST,
