...
void prim_init(Primitives *p, IF1 *if1) {
  ...
  prim_exp = new Prim(2, "**", "prim_exp", 3, 1, 1, prim_exp_arg_types, prim_exp_ret_types, 0);
  n = if1->strings.put("**");
  ...
  prim_mult = new Prim(3, "*", "prim_mult", 3, 1, 1, prim_mult_arg_types, prim_mult_ret_types, 0);
  n = if1->strings.put("*");
  ...
  prim_div = new Prim(4, "/", "prim_div", 3, 1, 1, prim_div_arg_types, prim_div_ret_types, 0);
  n = if1->strings.put("/");
  ...
  prim_mod = new Prim(5, "%", "prim_mod", 3, 1, 1, prim_mod_arg_types, prim_mod_ret_types, 0);
  n = if1->strings.put("%");
  ...
  prim_add = new Prim(6, "+", "prim_add", 3, 1, 1, prim_add_arg_types, prim_add_ret_types, 0);
  n = if1->strings.put("+");
  ...
  prim_subtract = new Prim(7, "-", "prim_subtract", 3, 1, 1, prim_subtract_arg_types, prim_subtract_ret_types, 0);
  n = if1->strings.put("-");
  ...
  prim_lsh = new Prim(8, "<<", "prim_lsh", 3, 1, 1, prim_lsh_arg_types, prim_lsh_ret_types, 0);
  n = if1->strings.put("<<");
  ...
  prim_rsh = new Prim(9, ">>", "prim_rsh", 3, 1, 1, prim_rsh_arg_types, prim_rsh_ret_types, 0);
  n = if1->strings.put(">>");
  ...
  prim_less = new Prim(10, "<", "prim_less", 3, 1, 1, prim_less_arg_types, prim_less_ret_types, 0);
  n = if1->strings.put("<");
  ...
  prim_lessorequal = new Prim(11, "<=", "prim_lessorequal", 3, 1, 1, prim_lessorequal_arg_types, prim_lessorequal_ret_types, 0);
  n = if1->strings.put("<=");
  ...
  prim_greater = new Prim(12, ">", "prim_greater", 3, 1, 1, prim_greater_arg_types, prim_greater_ret_types, 0);
  n = if1->strings.put(">");
  ...
  prim_greaterorequal = new Prim(13, ">=", "prim_greaterorequal", 3, 1, 1, prim_greaterorequal_arg_types, prim_greaterorequal_ret_types, 0);
  n = if1->strings.put(">=");
  ...
  prim_equal = new Prim(14, "==", "prim_equal", 3, 1, 1, prim_equal_arg_types, prim_equal_ret_types, 0);
  n = if1->strings.put("==");
  ...
  prim_notequal = new Prim(15, "!=", "prim_notequal", 3, 1, 1, prim_notequal_arg_types, prim_notequal_ret_types, 0);
  n = if1->strings.put("!=");
  ...
  prim_and = new Prim(16, "&", "prim_and", 3, 1, 1, prim_and_arg_types, prim_and_ret_types, 0);
  n = if1->strings.put("&");
  ...
  prim_xor = new Prim(17, "^", "prim_xor", 3, 1, 1, prim_xor_arg_types, prim_xor_ret_types, 0);
  n = if1->strings.put("^");
  ...
  prim_or = new Prim(18, "|", "prim_or", 3, 1, 1, prim_or_arg_types, prim_or_ret_types, 0);
  n = if1->strings.put("|");
  p->prims.add(prim_or);
  ...
  prim_land = new Prim(19, "&&", "prim_land", 3, 1, 1, prim_land_arg_types, prim_land_ret_types, 0);
  n = if1->strings.put("&&");
  ...
  prim_lor = new Prim(20, "||", "prim_lor", 3, 1, 1, prim_lor_arg_types, prim_lor_ret_types, 0);
  n = if1->strings.put("||");
  ...
  prim_assign = new Prim(21, "=", "prim_assign", 3, 1, 1, prim_assign_arg_types, prim_assign_ret_types, 0);
  n = if1->strings.put("=");
  ...
  prim_apply = new Prim(22, "^^", "prim_apply", 3, 1, 1, prim_apply_arg_types, prim_apply_ret_types, 0);
  n = if1->strings.put("^^");
  ...
  prim_by = new Prim(23, "by", "prim_by", 3, 1, 1, prim_by_arg_types, prim_by_ret_types, 0);
  ...
  prim_plus = new Prim(24, "+", "prim_plus", 2, 0, 1, prim_plus_arg_types, prim_plus_ret_types, 0);
  n = if1->strings.put("+");
  ...
  prim_minus = new Prim(25, "-", "prim_minus", 2, 0, 1, prim_minus_arg_types, prim_minus_ret_types, 0);
  n = if1->strings.put("-");
  ...
  prim_bnot = new Prim(26, "~", "prim_bnot", 2, 0, 1, prim_bnot_arg_types, prim_bnot_ret_types, 0);
  n = if1->strings.put("~");
  ...
  prim_not = new Prim(27, "!", "prim_not", 2, 0, 1, prim_not_arg_types, prim_not_ret_types, 0);
  n = if1->strings.put("!");
  ...
  prim_deref = new Prim(28, "*", "prim_deref", 2, 0, 1, prim_deref_arg_types, prim_deref_ret_types, 0);
  n = if1->strings.put("*");
  ...
  prim_ref = new Prim(29, "&", "prim_ref", 2, 0, 1, prim_ref_arg_types, prim_ref_ret_types, 0);
  n = if1->strings.put("&");
  ...
  prim_cast = new Prim(30, "(", "prim_cast", 3, 0, 1, prim_cast_arg_types, prim_cast_ret_types, 0);
  n = if1->strings.put("(");
  ...
  prim_sizeof = new Prim(31, "sizeof", "prim_sizeof", 2, 0, 1, prim_sizeof_arg_types, prim_sizeof_ret_types, 0);
  n = if1->strings.put("sizeof");
  p->prims.add(prim_sizeof);
  p->prim_map[0][0].put(n, prim_sizeof);
  static PrimType prim_reply_arg_types[] = {PRIM_TYPE_CONT, PRIM_TYPE_ANY};
  static PrimType prim_reply_ret_types[] = {PRIM_TYPE_ANY};
  prim_reply = new Prim(32, "reply", "prim_reply", -3, 0, 1, prim_reply_arg_types, prim_reply_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_tuple = new Prim(33, "make_tuple", "prim_tuple", -2, 0, 1, prim_tuple_arg_types, prim_tuple_ret_types, 0);
  ...
  prim_vector = new Prim(34, "make_vector", "prim_vector", -2, 0, 1, prim_vector_arg_types, prim_vector_ret_types, 0);
  ...
  prim_continuation = new Prim(35, "make_continuation", "prim_continuation", -2, 0, 1, prim_continuation_arg_types, prim_continuation_ret_types, 0);
  ...
  prim_new = new Prim(36, "new", "prim_new", -2, 0, 1, prim_new_arg_types, prim_new_ret_types, 0);
  ...
  prim_index_object = new Prim(37, "index_object", "prim_index_object", -3, 0, 1, prim_index_object_arg_types, prim_index_object_ret_types, 0);
  ...
  prim_meta_apply = new Prim(38, "meta_apply", "prim_meta_apply", 2, 0, 1, prim_meta_apply_arg_types, prim_meta_apply_ret_types, 0);
  n = if1->strings.put("meta_apply");
  p->prims.add(prim_meta_apply);
  p->prim_map[0][0].put(n, prim_meta_apply);
  static PrimType prim_destruct_arg_types[] = {PRIM_TYPE_ANY};
  static PrimType prim_destruct_ret_types[] = {PRIM_TYPE_ANY};
  prim_destruct = new Prim(39, "destruct", "prim_destruct", 2, 0, 1, prim_destruct_arg_types, prim_destruct_ret_types, PRIM_NON_FUNCTIONAL);
  ...
  prim_set = new Prim(40, "make_set", "prim_set", -2, 0, 1, prim_set_arg_types, prim_set_ret_types, 0);
  ...
  prim_list = new Prim(41, "make_list", "prim_list", -2, 0, 1, prim_list_arg_types, prim_list_ret_types, 0);
  ...
  prim_primitive = new Prim(42, "primitive", "prim_primitive", -2, 0, -1, prim_primitive_arg_types, prim_primitive_ret_types, PRIM_NON_FUNCTIONAL);
