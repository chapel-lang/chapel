/*   $Source: bitbucket.org:berkeleylab/gasnet.git/ofi-conduit/gasnet_extended_internal.h $
...
#define GASNETE_CONDUIT_EOP_FIELDS ofi_op_ctxt_t ofi;
#define GASNETE_CONDUIT_IOP_GET_FIELDS ofi_op_ctxt_t get_ofi;
#define GASNETE_CONDUIT_IOP_PUT_FIELDS ofi_op_ctxt_t put_ofi;
...
typedef struct _gasnete_iop_t {
  ...
  #ifdef GASNETE_CONDUIT_IOP_GET_FIELDS
  GASNETE_CONDUIT_IOP_GET_FIELDS
  #endif
  #ifdef GASNETE_CONDUIT_IOP_PUT_FIELDS
  GASNETE_CONDUIT_IOP_PUT_FIELDS
  #endif
} gasnete_iop_t;
