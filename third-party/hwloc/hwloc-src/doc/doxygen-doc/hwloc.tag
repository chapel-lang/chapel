...
<tagfile>
  ...
  <compound kind="page">
    ...
    <docanchor file="a00322" title="lstopo and lstopo-no-graphics">cli_lstopo</docanchor>
    <docanchor file="a00322" title="hwloc-bind">cli_hwloc_bind</docanchor>
    <docanchor file="a00322" title="hwloc-calc">cli_hwloc_calc</docanchor>
    <docanchor file="a00322" title="hwloc-info">cli_hwloc_info</docanchor>
    <docanchor file="a00322" title="hwloc-distrib">cli_hwloc_distrib</docanchor>
    <docanchor file="a00322" title="hwloc-ps">cli_hwloc_ps</docanchor>
    <docanchor file="a00322" title="hwloc-distances">cli_hwloc_distances</docanchor>
    <docanchor file="a00322" title="hwloc-annotate">cli_hwloc_annotate</docanchor>
    <docanchor file="a00322" title="hwloc-diff, hwloc-patch and hwloc-compress-dir">cli_hwloc_diffpatchcompress</docanchor>
    <docanchor file="a00322" title="hwloc-assembler">cli_hwloc_assembler</docanchor>
    <docanchor file="a00322" title="hwloc-assembler-remote">cli_hwloc_assembler_remote</docanchor>
    <docanchor file="a00322" title="hwloc-dump-hwdata">cli_hwloc_dump_hwdata</docanchor>
    <docanchor file="a00322" title="hwloc-gather-topology">cli_hwloc_gather</docanchor>
  </compound>
  <compound kind="page">
    <name>envvar</name>
  ...
  <compound kind="page">
    ...
    <docanchor file="a00325" title="Enabling and requirements">iodevices_enabling</docanchor>
    <docanchor file="a00325" title="I/O objects">iodevices_objects</docanchor>
    <docanchor file="a00325" title="OS devices">iodevices_osdev</docanchor>
    <docanchor file="a00325" title="PCI devices and bridges">iodevices_pci</docanchor>
    <docanchor file="a00325" title="Consulting I/O devices and binding">iodevices_consult</docanchor>
    <docanchor file="a00325" title="Examples">iodevices_examples</docanchor>
  </compound>
  <compound kind="page">
    <name>miscobjs</name>
    <title>Miscellaneous objects</title>
    <filename>a00326</filename>
    <docanchor file="a00326" title="Misc objects added by hwloc">miscobjs_auto</docanchor>
    <docanchor file="a00326" title="Annotating topologies with Misc objects">miscobjs_annotate</docanchor>
  </compound>
  <compound kind="page">
    <name>multinode</name>
    <title>Multi-node Topologies</title>
    <filename>a00327</filename>
    <docanchor file="a00327" title="Multi-node Objects Specifities">multinode_cpusets</docanchor>
    <docanchor file="a00327" title="Assembling topologies with command-line tools">multinode_tools</docanchor>
    <docanchor file="a00327" title="Assembling topologies with the programming interface">multinode_interface</docanchor>
    <docanchor file="a00327" title="Example of assembly with the programming interface">multinode_example</docanchor>
  </compound>
  <compound kind="page">
    <name>attributes</name>
    <title>Object attributes</title>
    <filename>a00328</filename>
    <docanchor file="a00328" title="Normal attributes">attributes_normal</docanchor>
    <docanchor file="a00328" title="Custom string infos">attributes_info</docanchor>
  </compound>
  <compound kind="page">
    <name>xml</name>
    <title>Importing and exporting topologies from/to XML files</title>
    <filename>a00329</filename>
    <docanchor file="a00329" title="libxml2 and minimalistic XML backends">xml_backends</docanchor>
    <docanchor file="a00329" title="XML import error management">xml_errors</docanchor>
  </compound>
  <compound kind="page">
    <name>synthetic</name>
    <title>Synthetic topologies</title>
    <filename>a00330</filename>
    <docanchor file="a00330" title="Synthetic description string">synthetic_string</docanchor>
    <docanchor file="a00330" title="Loading a synthetic topology">synthetic_use</docanchor>
    <docanchor file="a00330" title="Exporting a topology as a synthetic string">synthetic_export</docanchor>
  </compound>
  <compound kind="page">
  ...
  <compound kind="page">
    ...
    <docanchor file="a00333" title="Components enabled by default">plugins_default</docanchor>
    <docanchor file="a00333" title="Selecting which components to use">plugins_select</docanchor>
    <docanchor file="a00333" title="Loading components from plugins">plugins_load</docanchor>
    <docanchor file="a00333" title="Adding new discovery components and plugins">plugins_adding</docanchor>
    <docanchor file="a00333" title="Basics of discovery components">plugins_disc_basic</docanchor>
    <docanchor file="a00333" title="Registering a new discovery component">plugins_disc_register</docanchor>
    <docanchor file="a00333" title="Existing components and plugins">plugins_list</docanchor>
  </compound>
  <compound kind="page">
    <name>embed</name>
    <title>Embedding hwloc in Other Software</title>
    <filename>a00334</filename>
    <docanchor file="a00334" title="Using hwloc&apos;s M4 Embedding Capabilities">embedding_m4</docanchor>
    <docanchor file="a00334" title="Example Embedding hwloc">embedding_example</docanchor>
  </compound>
  <compound kind="page">
    <name>faq</name>
    <title>Frequently Asked Questions</title>
    <filename>a00335</filename>
    <docanchor file="a00335" title="Concepts">faq1</docanchor>
    <docanchor file="a00335" title="I only need binding, why should I use hwloc ?">faq_why</docanchor>
    <docanchor file="a00335" title="Should I use logical or physical/OS indexes? and how?">faq_indexes</docanchor>
    <docanchor file="a00335" title="hwloc is only a structural model, it ignores performance models, memory bandwidth, etc.?">faq_structural</docanchor>
    <docanchor file="a00335" title="hwloc only has a one-dimensional view of the architecture, it ignores distances?">faq_onedim</docanchor>
    <docanchor file="a00335" title="What are these Group objects in my topology?">faq_groups</docanchor>
    <docanchor file="a00335" title="What happens if my topology is asymmetric?">faq_asymmetric</docanchor>
    <docanchor file="a00335" title="What happens to my topology if I disable symmetric multithreading, hyper-threading, etc. in the system?">faq_nosmt</docanchor>
    <docanchor file="a00335" title="How may I ignore symmetric multithreading, hyper-threading, etc. in hwloc?">faq_smt</docanchor>
    <docanchor file="a00335" title="Advanced">faq2</docanchor>
    <docanchor file="a00335" title="I do not want hwloc to rediscover my enormous machine topology every time I rerun a process">faq_xml</docanchor>
    <docanchor file="a00335" title="How many topologies may I use in my program?">faq_multitopo</docanchor>
    ...
    <docanchor file="a00335" title="How do I handle ABI breaks and API upgrades?">faq_upgrade</docanchor>
    <docanchor file="a00335" title="Platform-specific">faq4</docanchor>
    <docanchor file="a00335" title="How do I find the local MCDRAM NUMA node on Intel Knights Landing Xeon Phi?">faq_knl_numa</docanchor>
