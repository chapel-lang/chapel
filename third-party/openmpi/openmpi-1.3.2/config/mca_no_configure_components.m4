...
m4_define([mca_paffinity_m4_config_component_list], [linux, solaris, windows, darwin, posix])
...
m4_define([mca_odls_m4_config_component_list], [default])
...
m4_define([mca_plm_m4_config_component_list], [alps, lsf, rsh, slurm, tm, xgrid])
m4_define([mca_ras_no_config_component_list], [])
m4_define([mca_ras_m4_config_component_list], [alps, gridengine, loadleveler, lsf, slurm, tm])
m4_define([mca_rmaps_no_config_component_list], [rank_file, round_robin, seq])
