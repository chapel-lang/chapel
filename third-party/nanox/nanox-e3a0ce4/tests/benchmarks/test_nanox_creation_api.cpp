...
nanos_smp_args_t empty_arg = { empty };
...
void barrier_code ( void * )
{
       ...
       for (int i=0; i < 1000000; i++) {
          nanos_wd_t wd=0;
          nanos_device_t fib_devices_2[1] = { NANOS_SMP_DESC(empty_arg) };
          ...
          NANOS_SAFE( nanos_create_wd ( &wd, 1, fib_devices_2 , 0, NULL, nanos_current_wd(), &props, 0, NULL ) );
