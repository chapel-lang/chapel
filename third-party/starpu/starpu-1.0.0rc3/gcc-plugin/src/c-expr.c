...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     YCPP_NUM = 259,
     YCPP_AND = 260,
     YCPP_OPEN_SQUARE = 261,
     YCPP_CLOSE_SQUARE = 262,
     YCPP_OPEN_PAREN = 263,
     YCPP_CLOSE_PAREN = 264,
     YCPP_PLUS = 265,
     YCPP_MINUS = 266,
     YCPP_MULT = 267,
     YCPP_DIV = 268,
...
#endif
/* Tokens.  */
#define YCPP_NAME 258
#define YCPP_NUM 259
#define YCPP_AND 260
#define YCPP_OPEN_SQUARE 261
#define YCPP_CLOSE_SQUARE 262
#define YCPP_OPEN_PAREN 263
#define YCPP_CLOSE_PAREN 264
#define YCPP_PLUS 265
#define YCPP_MINUS 266
#define YCPP_MULT 267
#define YCPP_DIV 268
#define YCPP_DOT 269
#define YCPP_DEREF 270
...
{
       0,   150,   150,   155,   162,   162,   162,   166,   169,   170,
     173,   176,   179,   182,   183,   186,   191,   196,   197,   198,
     204,   205,   216,   219,   226,   227,   228,   231
};
#endif
...
static const char *const yytname[] =
{
  ...
  "\"[\"", "\"]\"", "\"(\"", "\")\"", "\"+\"", "\"-\"", "\"*\"", "\"/\"",
  "\".\"", "\"->\"", "$accept", "sequence", "expression", "identifier",
...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (loc, pragma, seq, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, location_t loc, const char *pragma, tree *seq)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, loc, pragma, seq)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, location_t loc, const char *pragma, tree *seq)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, loc, pragma, seq)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    location_t loc;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, location_t loc, const char *pragma, tree *seq)
#else
static void
yy_reduce_print (yyvsp, yyrule, loc, pragma, seq)
    YYSTYPE *yyvsp;
    int yyrule;
    location_t loc;
    const char *pragma;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, Rule, loc, pragma, seq); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, location_t loc, const char *pragma, tree *seq)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, loc, pragma, seq)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    location_t loc;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (location_t loc, const char *pragma, tree *seq);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (location_t loc, const char *pragma, tree *seq)
#else
int
yyparse (loc, pragma, seq)
    location_t loc;
    const char *pragma;
    tree *seq;
#endif
...
#line 150 "c-expr.y"
    {
	  ...
	  *seq = tree_cons (NULL_TREE, (yyvsp[(1) - (1)]), NULL_TREE);
	  (yyval) = *seq;
      }
    break;
...
#line 155 "c-expr.y"
    {
	  gcc_assert ((yyvsp[(2) - (2)]) == *seq);
	  *seq = tree_cons (NULL_TREE, (yyvsp[(1) - (2)]), (yyvsp[(2) - (2)]));
	  (yyval) = *seq;
      }
    break;
...
#line 176 "c-expr.y"
    {
       (yyval) = build_binary_op (UNKNOWN_LOCATION, TRUNC_DIV_EXPR, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]), 0);
     }
    break;
...
#line 183 "c-expr.y"
    {
       (yyval) = build_binary_op (UNKNOWN_LOCATION, PLUS_EXPR, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]), 0);
     }
    break;
...
#line 186 "c-expr.y"
    {
       (yyval) = build_binary_op (UNKNOWN_LOCATION, MINUS_EXPR, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]), 0);
     }
    break;
...
#line 205 "c-expr.y"
    {
	 ...
	 (yyval) = build_array_ref (loc, ensure_bound (loc, (yyvsp[(1) - (4)])),
			       ensure_bound (loc, (yyvsp[(3) - (4)])));
#else /* TIMTOWTDI */
	 (yyval) = build_indirect_ref (loc,
	       build_binary_op (loc, PLUS_EXPR, ensure_bound (loc, (yyvsp[(1) - (4)])), ensure_bound (loc, (yyvsp[(3) - (4)])), 0),
		RO_ARRAY_INDEXING);
#endif
     }
    break;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (loc, pragma, seq, YY_("syntax error"));
#else
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, loc, pragma, seq);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (loc, pragma, seq, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, loc, pragma, seq);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
