...
double qutil_double_sum(const double *array, size_t length,
			int checkfeb);
double qutil_double_mult(const double *array, size_t length,
			 int checkfeb);
double qutil_double_max(const double *array, size_t length,
			int checkfeb);
double qutil_double_min(const double *array, size_t length,
			int checkfeb);
