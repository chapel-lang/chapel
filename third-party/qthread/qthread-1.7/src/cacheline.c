...
static void cpuid(const unsigned int op,
...
# if (QTHREAD_ASSEMBLY_ARCH == QTHREAD_IA32) && defined(__PIC__)
    ...
    __asm__ __volatile__ ("mov %%ebx, %4\n\t"
                          ...
                          "mov %%ebx, %1\n\t"
                          "mov %4, %%ebx"
                          : "=a" (eax), "=m" (ebx), "=c" (ecx), "=d" (edx), "=m" (pic_ebx)
                          : "a" (op), "m" (pic_ebx));
    *eax_ptr = eax;
    *ebx_ptr = ebx;
    *ecx_ptr = ecx;
    *edx_ptr = edx;
# else /* if (QTHREAD_ASSEMBLY_ARCH == QTHREAD_IA32) && defined(__PIC__) */
...
static void cpuid4(const int     cache,
                   unsigned int *eax_ptr,
                   unsigned int *ebx_ptr,
                   unsigned int *ecx_ptr,
                   unsigned int *edx_ptr)
...
# endif
        ...
        case 0x0d: case 0x21: case 0x22: case 0x23: case 0x25:
        case 0x29: case 0x2c: case 0x39: case 0x3a: case 0x3b:
        case 0x3c: case 0x3d: case 0x3e: case 0x46: case 0x47:
        case 0x48: case 0x49: case 0x4a: case 0x4b: case 0x4c:
        case 0x4d: case 0x4e: case 0x60: case 0x66: case 0x67:
        case 0x68: case 0x78: case 0x79: case 0x7a: case 0x7b:
        case 0x7c: case 0x7d: case 0x7f: case 0x86: case 0x87:
...
# endif
        ...
        case 0x08: case 0x09: case 0x30: case 0x40: case 0x50:
        case 0x51: case 0x52: case 0x55: case 0x56: case 0x57:
        case 0x5a: case 0x5b: case 0x5c: case 0x5d: case 0x70:
        case 0x71: case 0x72: case 0x73: case 0xb0: case 0xb1:
        case 0xb2: case 0xb3: case 0xb4: case 0xca: case 0xf0:
        case 0xf1:
            return;
...
#endif /* if ((QTHREAD_ASSEMBLY_ARCH == QTHREAD_IA32) || (QTHREAD_ASSEMBLY_ARCH == QTHREAD_AMD64)) && defined(HAVE_GCC_INLINE_ASSEMBLY) */
