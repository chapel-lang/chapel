 ...
 * associated with the specified static-size map. The dynmalloc() function
 * allocates one chunk of at least "size" bytes from the specified dynamic-size
 * map. The malloc() function merges the previous two; if the specified map is a
