...
/* Typedefs                                                 */
/************************************************************/
typedef enum { REGION_BARRIER, LOOP_BARRIER } qt_barrier_btype;

typedef enum { UPLOCK, DOWNLOCK, BOTHLOCKS } qt_barrier_dtype;
...
/* Functions                                                */
/************************************************************/
qt_barrier_t *qt_barrier_create(size_t max_threads, qt_barrier_btype type);
void qt_barrier_enter(qt_barrier_t *b);
void qt_barrier_enter_id(qt_barrier_t *b, size_t id);
void qt_barrier_destroy(qt_barrier_t *b);
void qt_barrier_resize(qt_barrier_t *b, size_t size);
