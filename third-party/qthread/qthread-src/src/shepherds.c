...
int API_FUNC
qthread_disable_shepherd(qthread_shepherd_id_t const shep) { /*{{{ */
  assert(qthread_library_initialized);
...
void API_FUNC
qthread_enable_shepherd(qthread_shepherd_id_t const shep) { /*{{{ */
  assert(qthread_library_initialized);
...
qthread_find_active_shepherd(qthread_shepherd_id_t *l,
                             unsigned int *d) { /*{{{ */
