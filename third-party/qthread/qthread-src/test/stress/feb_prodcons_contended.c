...
int main(int argc, char *argv[]) {
  ...
  if (x_value == iterations - 1) {
    ...
    fprintf(stderr,
            "Final value of x=%lu, expected %lu\n",
            (unsigned long)x_value,
