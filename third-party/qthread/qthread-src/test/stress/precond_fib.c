...
static aligned_t fib_result(void *arg) {
  ...
  if (validation[((fr_arg_t *)arg)->fargs[0].n] !=
      ((fr_arg_t *)arg)->fargs[0].result) {
    fprintf(stdout,
            "%u:%u(%p) should be %u (0)\n",
            (unsigned)((fr_arg_t *)arg)->fargs[0].n,
            (unsigned)((fr_arg_t *)arg)->fargs[0].result,
            &((fr_arg_t *)arg)->fargs[0].result,
  ...
  if (validation[((fr_arg_t *)arg)->fargs[1].n] !=
    ...
    fprintf(stdout,
            "%u:%u(%p) should be %u (1)\n",
            (unsigned)((fr_arg_t *)arg)->fargs[1].n,
            (unsigned)((fr_arg_t *)arg)->fargs[1].result,
            &((fr_arg_t *)arg)->fargs[1].result,
