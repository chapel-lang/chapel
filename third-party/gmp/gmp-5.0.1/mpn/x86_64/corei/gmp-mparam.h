...
#define MUL_FFT_TABLE3                                      \
  { {    396, 5}, {     17, 6}, {      9, 5}, {     19, 6}, \
    ...
    {    543,11}, {    143,10}, {    287, 9}, {    607,10}, \
    {    319,12}, {     95,11}, {    191,10}, {    383,13}, \
    {     63,12}, {    127,11}, {    255,10}, {    511, 9}, \
    ...
    {    127,11}, {    511,10}, {   1023,11}, {    543,12}, \
    {    287,11}, {    575,10}, {   1151,11}, {    607,12}, \
    {    319,11}, {    671,12}, {    351,11}, {    703,10}, \
    {   1407,12}, {    383,11}, {    767,12}, {    415,11}, \
    ...
    {   1791,14}, {  16384,15}, {  32768,16}, {  65536,17}, \
...
#define SQR_FFT_TABLE3                                      \
  { {    308, 5}, {     17, 6}, {      9, 5}, {     19, 6}, \
    ...
    {    127, 9}, {    255, 8}, {    511,10}, {    135, 8}, \
    {    543,11}, {     79, 9}, {    319,11}, {     95, 9}, \
    {    415,12}, {     63,11}, {    127, 8}, {   1087,10}, \
    {    287, 9}, {    575,10}, {    319,12}, {     95,10}, \
    {    383,13}, {     63,12}, {    127,11}, {    255,10}, \
    {    511, 9}, {   1023,11}, {    287,10}, {    575, 9}, \
    {   1151,11}, {    319,10}, {    639, 9}, {   1279,10}, \
    ...
    {   2431,13}, {   4863,15}, {   1279,14}, {   2943,15}, \
