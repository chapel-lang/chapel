...
mv llvm-6.0.0.src llvm-src
mv cfe-6.0.0.src llvm-src/tools/clang
...
#mv llvm-5.0.1.src llvm-src
#mv cfe-5.0.1.src llvm-src/tools/clang
...
#mv llvm-4.0.1.src llvm-src
#mv cfe-4.0.1.src llvm-src/tools/clang
#patch -p0 < llvm-4.0.1-BasicAliasAnalysis-patch.txt
#patch -p0 < llvm-4.0.1-ValueTracking-patch.txt
