...
#if (defined(GM) || defined(VAPI) || defined(QUADRICS) || defined(SOCKETS)) && defined(ARMCI_ENABLE_GPC_CALLS)
...
/*   fprintf(stderr, "%d:: armci gpc exec. invoking armci gpc on proc=%d\n", armci_me,p); */
/*   sleep(1); */
