...
switch (to->const_kind) {
 ...
 case NUM_KIND_BOOL:
   ...
   case NUM_KIND_IMAG:
     switch (from->num_index) {
     case FLOAT_SIZE_16:
       to->v_bool = (bool)!!from->v_float16; break;
     case FLOAT_SIZE_32:
 ...
 case NUM_KIND_UINT:
   ...
   case INT_SIZE_8:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_uint8 = (uint8_t)from->v_float16; break;
       case FLOAT_SIZE_32:
   ...
   case INT_SIZE_16:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_uint16 = (uint16_t)from->v_float16; break;
       case FLOAT_SIZE_32:
   ...
   case INT_SIZE_32:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_uint32 = (uint32_t)from->v_float16; break;
       case FLOAT_SIZE_32:
   ...
   case INT_SIZE_64:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_uint64 = (uint64_t)from->v_float16; break;
       case FLOAT_SIZE_32:
 ...
 case NUM_KIND_INT:
   ...
   case INT_SIZE_8:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_int8 = (int8_t)from->v_float16; break;
       case FLOAT_SIZE_32:
   ...
   case INT_SIZE_16:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_int16 = (int16_t)from->v_float16; break;
       case FLOAT_SIZE_32:
   ...
   case INT_SIZE_32:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_int32 = (int32_t)from->v_float16; break;
       case FLOAT_SIZE_32:
   ...
   case INT_SIZE_64:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_int64 = (int64_t)from->v_float16; break;
       case FLOAT_SIZE_32:
 ...
 case NUM_KIND_IMAG:
   ...
   case FLOAT_SIZE_32:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_float32 = (float)from->v_float16; break;
       case FLOAT_SIZE_32:
   ...
   case FLOAT_SIZE_64:
     ...
     case NUM_KIND_IMAG:
       switch (from->num_index) {
       case FLOAT_SIZE_16:
         to->v_float64 = (double)from->v_float16; break;
       case FLOAT_SIZE_32:
 ...
 case CONST_KIND_STRING:
   ...
   case NUM_KIND_REAL:
     switch (from->num_index) {
     case FLOAT_SIZE_16:
       to->v_string = istrFromUserDouble(context, from->v_float16); break;
     case FLOAT_SIZE_32:
   ...
   case NUM_KIND_IMAG:
     switch (from->num_index) {
     case FLOAT_SIZE_16:
       to->v_string = istrFromUserImag(context, from->v_float16); break;
     case FLOAT_SIZE_32:
