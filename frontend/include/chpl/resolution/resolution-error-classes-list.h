...
ERROR_CLASS(RecursionFieldDecl, const uast::AstNode*, const uast::AggregateDecl*, const types::CompositeType*)
ERROR_CLASS(RecursionModuleStmt, const uast::AstNode*, const uast::Module*)
