...
def get():
    ...
    if comm_val == "gasnet" and substrate_val == "udp":
        if not launcher_val:
            ...
            error(
                "CHPL_LAUNCHER={} is not supported for CHPL_COMM=gasnet "
        ...
        if comm_val == "gasnet":
            ...
            if chpl_platform.is_cluster("target"):
                ...
                if has_aprun and has_slurm:
                    launcher_val = "none"
                    warning(
                        "Both 'aprun' and 'srun' are available on this system. Please explicitly set CHPL_LAUNCHER."
                    )
                elif has_aprun:
                    launcher_val = "aprun"
                elif has_slurm:
                    ...
                    launcher_val = "none"
                    warning(
                        "Cannot detect launcher on this system. Please "
    ...
    valid_values.extend(
        ["slurm-gasnetrun_{}".format(l) for l in gasnet_launchers]
    )
