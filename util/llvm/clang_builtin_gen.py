...
def main():
    ...
    result = ["/* Generated by clang_builtin_gen.py based on clang's Builtins.def */"]
    for b in builtins:
    ...
    wrapperLocation = chplHome+"/runtime/include/llvm/clang_builtins_wrapper.h"
    with open(chplHome+"/runtime/include/llvm/clang_builtins_wrapper.h", 'w') as wrapper:
        wrapper.write("\n".join(result))

    runLicenseScript(wrapperLocation)

    eprint("Wrapper saved to " + wrapperLocation)
