...
c:\cygwin64\bin\bash -exc "export PATH='/usr/local/bin:/usr/bin:/cygdrive/c/Windows/system32:/cygdrive/c/Windows:/cygdrive/c/Windows/System32/Wbem' ; export CHPL_HOME=$PWD ; export CHPL_LLVM=none ; export PIP_CONSTRAINT=$CHPL_HOME/util/test/cygwin-constraint.txt; source $CHPL_HOME/util/cron/common.bash && export CHPL_NIGHTLY_TEST_CONFIG_NAME="cygwin64" && export CHPL_NIGHTLY_TEST_DIRS='release/examples/ library/ runtime/configMatters/' && $CHPL_HOME/util/cron/nightly -cron"
GOTO End
