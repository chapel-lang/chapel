...
The intents \chpl{const}, \chpl{const in}, \chpl{const ref},
\chpl{in}, \chpl{out}, \chpl{inout} and \chpl{ref} are discussed
...
type~(see \rsec{Method_receiver_and_this}) is \chpl{ref} or \chpl{const ref}.
It is \chpl{ref} if the formal argument is modified inside the
