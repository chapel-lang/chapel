...
\item
 ...
 \item
 If $F1$ is partially concrete generic and $F2$ is generic and not
 partially concrete, $M_1$ is more specific.
\item
 If $F1$ is generic and not partially concrete  and $F2$ is partially
 concrete generic, $M_2$ is more specific.
\item
