...
In tuple assignment, the compoonents of the tuple on the left-hand
...
Variable declarations are not supported with a tuple currently.
\end{implementation}
...
it appears as a top-level type in a variable declaration or type alias
declaration:
\begin{syntax}
...
indexing expression can be known at compile-time.
