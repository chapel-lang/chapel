...
sequences~(\rsec{Sequence_Assignment}),
...
The use statement makes symbols in a module available without accessing
...
\end{syntax}
The use statement makes symbols in the module's scope available in the
scope where the use statement occurs.
