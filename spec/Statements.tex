...
described in~\rsec{Parallelism_and_Synchronization}.
The \sntx{on-statement} is defined in~\rsec{On}.  The compiler error
statement is defined in~\rsec{User_Defined_Compiler_Errors}.
