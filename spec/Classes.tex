...
method-declaration-statement:
  `def' type-binding function-name argument-list[OPT] var-param-type-clause[OPT]
...
will invoke \chpl{C}'s default constructor. The \chpl{y} and \chpl{z} arguments
of the default constructor have the default values \chpl{3.14} and
