...
variabl of class type either refers to a class instance, or contains a
...
\snxt{delete-statement} (\rsec{Class_Delete}).
...
component called the lifetime checker. It identifies some where a
