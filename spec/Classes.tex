...
1          32         C
==============================================================
\end{chapelwideoutput}
% The reason for the no-local .good file is that calls to mem tracking now
% add wide string copies that are apparently leaked (or at least held while
% mem tracking proceeds.
\end{chapelexample}
