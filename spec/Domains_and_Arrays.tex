...
and then using that subdomain to slice the array.
...
composed of indefinite ranges.  In such cases, the omitted bounds of
the indefinite ranges are taken from the bounds of the base domain.
