...
Enumerated domains do not support the \chpl{add}, \chpl{remove},
or \chpl{clear} methods.  All of the constants defined by the enumerated
type are indices into the enumerated domain.
