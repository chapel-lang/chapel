...
\item From \chpl{int(8)} to \chpl{int(16)}, \chpl{int(32)}, \chpl{int(64)}, \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
\item From \chpl{int(16)} to \chpl{int(32)}, \chpl{int(64)}, \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
\item From \chpl{int(32)} to \chpl{int(64)}, \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
\item From \chpl{int(64)} to \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
\item From \chpl{uint(8)} to \chpl{int(16)}, \chpl{int(32)}, \chpl{int(64)}, \chpl{uint(16)}, \chpl{uint(32)}, \chpl{uint(64)}, \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
\item From \chpl{uint(16)} to \chpl{int(32)}, \chpl{int(64)}, \chpl{uint(32)}, \chpl{uint(64)}, \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
\item From \chpl{uint(32)} to \chpl{int(64)}, \chpl{uint(64)}, \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
\item From \chpl{uint(64)} to \chpl{real(64)}, \chpl{real(128)}, \chpl{complex(128)}, \chpl{complex(256)}, or \chpl{string}
...
or \chpl{int(16)} to \chpl{real(32)} either because to do so would
result in an ambiguity when computing, e.g., \chpl{int(8) + int(8)}.
\end{rationale}
