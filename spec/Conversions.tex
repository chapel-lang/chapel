...
numeric, boolean, and enumerated types~(\rsec{Implicit_NumBoolEnum_Conversions}),
between class
...
\chpl{bool} in the context of a statement~(\rsec{Implicit_Statement_Bool_Conversions}).

%VASS TODO: add forward ref for bools to the above.
