...
Domains and arrays are discussed in~\rsec{Domains_and_Arrays}.  Sync
and single types are discussed in~\rsec{Sync_Variables}
...
in this section except for the \chpl{locale} type which is defined
in~\rsec{The_Locale_Type}.  The syntax of a primitive type is
