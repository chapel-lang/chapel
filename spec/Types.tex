...
\chpl{string}, and \chpl{locale}.  They are defined
in this section.
...
default unsigned integral type, \chpl{uint}, are treated as distinct types (for
...
%REVIEW: vass: move the reference below to the top of
% the Primitive Types section and remove this subsection.
\subsection{The Locale Type}
\label{Locale_Types}
\index{types!locale}
