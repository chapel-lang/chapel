...
The linkage specifier \chpl{inline} indicates that the function body should be
inlined at every call site.  
The linkage specifier \chpl{export} indicates that this function may be called
...
The linkage specifier \chpl{extern} indicates that this function is defined
outside the Chapel program.  If used, it is not permissible to supply
a \sntx{where-clause} or a \sntx{function-body}.  The function signature
