...
The optional \sntx{identifier} represents a named actual
...
Intents~(\rsec{Intents}) may modify the above default
parameter passing mechanism and result in potential assignments to temporary
variables during a function call.  For example, when passing an array by
intent \chpl{in}, a temporary array will be created and used within
the function; it will be initialized to a copy of the argument array.
...
variable argument expression takes on the value that is a tuple of the actual
arguments.
