...
``more specific function'' is defined
in~\rsec{Determining_the_Most_Specific_Function}.
\end{enumerate}.

\subsubsection{Identifying Visible Functions}
\label{Identifying_Visible_Functions}
\index{functions!visibility}
...
\subsubsection{Determining the Most Specific Function}
\label{Determining_the_Most_Specific_Function}

This is a stub.  This portion of the document does not exist.

visibility as a tie-breaker
