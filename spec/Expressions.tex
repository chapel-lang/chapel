...
\begin{chapel}
if a.isTrue then b.isTrue else false
\end{chapel}

The method \chpl{isTrue} is predefined over bool type as follows:
\begin{chapel}
def bool.isTrue return this;
\end{chapel}
Overloading the logical and operator over other types is accomplished
by overloading the \chpl{isTrue} method over other types.
...
is evaluated as the expression
\begin{chapel}
if a.isTrue then true else b.isTrue
\end{chapel}

The method \chpl{isTrue} is predefined over bool type as described
