...
\begin{chapel}
if a.true? then b.true? else false
\end{chapel}

The method \chpl{true?} is predefined over bool type as follows:
\begin{chapel}
def bool.true? return this;
\end{chapel}
Overloading the logical and operator over other types is accomplished
by overloading the \chpl{true?} method over other types.
...
The method \chpl{true?} is predefined over bool type as described
in~\rsec{Logical_And_Operators}.  Overloading the logical or operator
over other types is accomplished by overloading the \chpl{true?}
