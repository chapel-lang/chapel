...
of values of type \chpl{idxType} can be used to initialize or assign to a variable
of associative domain type.

\index{domains!associative!default values}

The default value of an associative domain type is the empty index set,
except for enumerated domains.
