...
values for the root domain types are defined in~\rsec{Domain_Values}.
The domain values for sparse subdomain types are defined
in~\rsec{Sparse_Domain_Values}.
...
map.  The optional \syntx{sparse} keyword permits the ability to
...
of the array's elements as described in~\rsec{Array Rank-Change
Slicing}.
...
% TODO: Need to define exterior, interior, etc.
