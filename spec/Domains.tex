...
\section{Domain Types and Values}
\label{Domain_Types_and_Values}
...
\end{chapel}
\begin{chapelprintoutput}
associativeDomain.chpl:1: warning: whole-domain assignment has been serialized (see note in (*\texttt{\$}*)CHPL\_HOME/STATUS)
{foo, bar}
\end{chapelprintoutput}
\end{chapelexample}
