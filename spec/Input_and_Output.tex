...
\index{input/output!channel}
\index{input/output!types!channel}
...
\index{input/output!iostyle@\chpl{iostyle}!default value}
...
\index{input/output!channels!style}
...
\index{input/output!defaultStyle@\chpl{defaultStyle}}
\index{input/output!channels!defaultStyle@\chpl{defaultStyle}}
\begin{protohead}
...
\index{input/output!channels!modifyStyle}
\begin{protohead}
