...
The built-in procedure \chpl{write} takes an arbitrary number of
...
The built-in procedure \chpl{read} takes an arbitrary number of
...
argument from the next.  The built-in procedure \chpl{readln} is
