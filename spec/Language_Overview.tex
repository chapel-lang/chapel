...
To set \chpl{debug} at compile time, the following compile command
and flag is used.
\begin{commandline}
...
also includes an initialization for the domain using the range literal
expression \chpl{1..n},
...
is enclosed in parentheses.  Tuples can be declared and assigned to with
