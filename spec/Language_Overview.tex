...
its encapsulation of related data and code within a single software
...
a call to the standard \chpl{writeln} procedure.
...
define a single entry point via a procedure named \chpl{main}.  To
...
the single \chpl{hello} module, the \chpl{main} procedure is omitted.
...
call to the \chpl{writeln} procedure.  Modules are described in more
