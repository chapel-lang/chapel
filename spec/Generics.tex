...
in the Chapel program from which the function containing the
\sntx{compiler-diagnostic-statement} is called.  Compilation typically
halts if a \chpl{compilerError} is encountered whereas it will
continue after encountering a \chpl{compilerWarning}.
