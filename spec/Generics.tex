...
\end{chapel}
\begin{chapelpost}
var n: Node(real) = new unmanaged Node(real, 3.14);
writeln(n.data);
writeln(n.next);
...
var g1 = new borrowed MyGenericClass(11, 111, int, 1);
var g2 = new borrowed MyGenericClass(int, "this is g2", 3.3, 333, 3333,
                                     real, 2, 222, 222.2, 22);
\end{chapel}
\begin{chapelpost}
writeln(g1.p1);
