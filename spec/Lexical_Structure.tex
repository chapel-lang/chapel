...
int         inout       iterator    let         locale
module      nil         of          on          ordered
otherwise   out         param       pragma      range
real        record      reduce      return      scan
select      serial      single      sync        then
true        type        uint        union       use
