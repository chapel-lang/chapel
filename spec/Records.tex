...
\subsubsection{No \chpl{nil} Value}
\index{nil!not provided for records}

There is no counterpart of the \chpl{nil} value for records.  A record
with all fields set to their corresponding default values is the
closest concept to \chpl{nil}. It is different, however, in that it is
