...
same way as the default initializer for a class (\rsec{The_Compiler_Generated_Initializer}).
For non-generic records, the initializer is invoked with zero arguments.
