...
\begin{future}
Record inheritance is not yet implemented.
\end{future}
...
\begin{future}
Record inheritance has not yet been implemented.
A compile-time error will be generated if a \sntx{record-inherit-list} is
supplied in a record declaration.
\end{future}
