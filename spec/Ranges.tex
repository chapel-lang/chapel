...
\item whether or not the rante is \emph{aligned}.
\end{enumerate}
...
value can tack on any integer value representable by its \emph{idxType}.  If it
...
\begin{chapelpost}
writeln(r1, " is:");
for i in r1 do write(" ", i);
writeln();
writeln(r2, " is:");
for i in r2 do write(" ", i);
writeln();
\end{chapelpost}
\begin{chapeloutput}
1..10 by 2 is:
 1 3 5 7 9
1..10 by 2 align 1 is:
 2 4 6 8 10
\end{chapeloutput}
\end{example}
