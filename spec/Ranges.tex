...
The final section (\rsec{Predefined_Range_Procedures}) lists the remaining
procedures in the range library, divided into the following subsections: type
...
%TODO: bradc: so it doesn't correlate to the aligned field mention prev?
%Confusing! Should be renamed to isNaturallyAligned.
...
\section{Predefined Range Procedures}
...
\end{protohead}
%TODO: bradc: Rename as isNaturallyAligned.
\begin{protobody}
