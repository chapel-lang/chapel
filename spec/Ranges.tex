...
The \chpl{#} operator takes a range and an integral count and creates a
new range with count elements. The stride of the resulting range is the
same as that of the initial range. It is an error for the count to be
negative.
