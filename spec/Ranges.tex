...
arrays, and strings.  In thesse cases, elided bounds are inherited
...
range, but illegal to asssign a stridable range to a non-stridable
range.
...
range is unbounded in one or both dimensions, it inherits its upper
and lower bounds from the range being sliced.
