...
of such a range is \chpl{BoundedType.bounded}.  The stridability of
...
The first form results in a \chpl{BoundedType.boundedLow} range, the
second in a \chpl{BoundedType.boundedHigh} range, and the third in
a \chpl{BoundedType.boundedNone} range.
