...
The procedures and other definitions of automatic modules are always
...
\end{protohead}
\begin{protobody}
Supplies the floating point constant for infinity and
not a number. Returns whether or not a particular value
is finite, infinite, or not a number.
\end{protobody}
