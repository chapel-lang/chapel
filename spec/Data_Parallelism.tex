...
The forall statement is presented in~\rsec{Forall}.  The forall
expression is presented in~\rsec{Forall_Expressions}.  Promotion is
presented in~\rsec{Promotion}.  Reductions and scans are presented
in~\rsec{Reductions_and_Scans}.  Configuration constants for
controlling default data parallelism are presented
in~\rsec{data_parallel_knobs}.
...
by a forall expression.  A filtering predicate does not require an
...
Zipper promotion blah blah blah FIX ME!
