...
\subsection{The End Statement}
\label{End}
\index{end@\chpl{end}}

The end statement is a join of all dynamically encountered begins from
within a statement.  The syntax for the end statement is given by
\begin{syntax}
end-statement:
  `end' statement
\end{syntax}

The following statements cannot be contained in end-statements:
break-statements, continue-statements, yield-statements, and
return-statements.
