...
structure of standard modules that are provided with the Chapel language
and the \chpl{Base} standard module.

\item
The other standard modules, as well as the standard domain maps
(layouts and distributions), are described in the online documentation:
