...
\begin{example}
%
% 1/7/10: This is currently a bug (does not cause compiler error).
%
% This example code is in test/modules/sungeun/test_ambiguity.chpl
%
...
\begin{chapelexecopts}
 \# test\_main\_module.M1.good
 \# test\_main\_module.M2.good
\end{chapelexecopts}
