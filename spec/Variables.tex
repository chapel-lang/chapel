...
var a = 1.0, b, c:int;
\end{chapel}
the variable \chpl{a} is inferred to be of type \chpl{real} because the
initializer, \chpl{1.0}, is a real.  The variables \chpl{b} and \chpl{c}
are declared to have type \chpl{int} and are initialized to the default
\chpl{int} value.
\end{example}
