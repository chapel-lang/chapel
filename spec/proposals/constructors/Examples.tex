...
the default value for each field would still require writing the full binary matrix
...
elementType is supplied as an argument, and the a pointer to the domain is passed to the
...
initialize function explicitly.  
...
construcion of the object has been factored --- specifically, the call to the
