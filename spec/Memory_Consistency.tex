...
$<_p$ \textit{program order}. \todo {is there supposed to be more to this
sentence?} For the purposes of this section, the statements in the body of each
...
it to a list of tasks executing in dynamic scope (\chpl{t = begin\{X\}}).
  ...
  \item \chpl{sync} statement waits for \todo{"any" $=>$ "all"?} any of the $n$ tasks $t_i$ created in
