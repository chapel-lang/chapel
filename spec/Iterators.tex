...
An iterator is a function that can generate, or \emph{yield}, multiple values (consecutively or in parallel) via its yield statements.
...
\section{Iterator Function Definitions}
