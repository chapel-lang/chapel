...
A more detailed definition of parallel iterators is forthcoming.  The
following paper sketches out the parallel iterator interface:
\begin{quote}
B.~L.~Chamberlain, S.~Choi, ~S.~J.~Deitz, and A.~Navarro.  {\bf
Composable Parallel Iterators in Chapel}. 2011.
\end{quote}
