...
if __name__ == "__main__":
    if sys.argv[0].endswith("shimchapel.py"):
        ...
        os.environ["CHPL_SHIM_TARGET_PATH"] = tempdir.name
        os.environ["CHPL_SHIM_REAL_COMPILER_PATH"] = chpl
        ...
        # Being invoked a wrapper script
