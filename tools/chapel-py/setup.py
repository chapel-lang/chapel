...
setup(name = "chapel",
      ...
      ext_modules = [Extension("chapel.core", ["src/chapel.cpp", "src/core-types.cpp", "src/core-types-pernode.cpp", "src/iterator-support.cpp", "src/error-tracker.cpp"], extra_compile_args = CXXFLAGS, extra_link_args=LDFLAGS)]
      )
