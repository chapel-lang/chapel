...
considered if no input is given.""");
  ...
  if defVer == '' then defaultVersion = "0.1.0";
  else defaultVersion = defVer;
  var chapelVersion: string;
  var currChapelVersion;
  if defChplVer == '' then currChapelVersion = getChapelVersionStr();
  else currChapelVersion = defChplVer;
