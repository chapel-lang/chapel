...
(defconst c-Chpl-specifier-kwds
  "config\\|const\\|var")
...
(defconst c-Chpl-class-kwds "record\\|union\\|class")
...
(defconst c-Chpl-extra-toplevel-kwds "module")
...
(defconst c-Chpl-other-decl-kwds "enum\\|type\\|typedef")
...
(defconst c-Chpl-block-stmt-1-kwds "then\\|else\\|do")
...
(defconst c-Chpl-block-stmt-2-kwds "for\\|forall\\|if\\|select\\|typeselect\\|while\\|do")
...
(defconst c-Chpl-simple-stmt-kwds "break\\|continue\\|goto\\|return")
...
(defconst c-Chpl-label-kwds "when\\|otherwise")
...
(defconst c-C++-keywords
  (concat c-C++-primitive-type-kwds "\\|" c-C++-specifier-kwds
	  ...
	  "\\|" c-C++-simple-stmt-kwds "\\|" c-C++-label-kwds
	  "\\|" c-C++-expr-kwds))
(defconst c-Chpl-keywords
  (concat c-Chpl-primitive-type-kwds "\\|" c-Chpl-specifier-kwds
          "\\|" c-Chpl-class-kwds "\\|" c-Chpl-extra-toplevel-kwds
          "\\|" c-Chpl-other-decl-kwds
          ;; "\\|" c-Chpl-decl-level-kwds "\\|" c-Chpl-protection-kwds
          "\\|" c-Chpl-block-stmt-1-kwds "\\|" c-Chpl-block-stmt-2-kwds
          "\\|" c-Chpl-simple-stmt-kwds "\\|" c-Chpl-label-kwds
          "\\|" c-Chpl-expr-kwds))
...
(defconst c-C++-class-key (c-paren-re c-C++-class-kwds))
(defconst c-Chpl-class-key (c-paren-re c-Chpl-class-kwds))
...
(defconst c-C++-extra-toplevel-key (c-paren-re c-C++-extra-toplevel-kwds))
(defconst c-Chpl-extra-toplevel-key (c-paren-re c-Chpl-extra-toplevel-kwds))
...
(defconst c-C++-conditional-key nil)
(defconst c-Chpl-conditional-key nil)
...
(defconst c-Chpl-comment-start-regexp "@@")
...
(defvar c-comment-start-regexp c-Chpl-comment-start-regexp)
...
(if chpl-mode-syntax-table
    ()
  (setq chpl-mode-syntax-table (make-syntax-table))
  (c-populate-syntax-table chpl-mode-syntax-table)
  (modify-syntax-entry ?-  ". 12b" chpl-mode-syntax-table)
;  (modify-syntax-entry ?-- "\\" chpl-mode-syntax-table)
  )
