...
This pass also calls the \cc{collapseBlocks} and
\cc{removeUnnecessaryGotos} functions on every function.  These
...
In this pass, the compiler creates a wide reference type for every
type and a wide class for every class.  This includes both wide
references to classes and wide references to wide classes.
Fortunately, there are no references to references, references to wide
references, wide references to references, or wide references to wide
references.  Because enough is enough!
