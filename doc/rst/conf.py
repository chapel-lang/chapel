...
copyright = u"2021, {0}".format(author_text)
...
latex_documents = [
    ("index", "chapel.tex", u"Chapel Documentation", author_text, "manual"),
]
...
man_pages = [("index", "chapel", u"Chapel Documentation", [author_text], 1)]
