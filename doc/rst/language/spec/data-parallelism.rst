...
Most formal arguments of a task function or iterator have the default
...
forall if it is modifiable outside the body of the forall. A mutable array can
have an explicit ``const`` forall intent to make it immutable inside the body of
a forall.
