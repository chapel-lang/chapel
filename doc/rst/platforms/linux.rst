...
..
  Autogenerated by util/packaging/common/list_package_configs.py  --format rst --split

  The tables below are autogenerated.
  To regenerate them:
    ./util/packaging/common/list_package_configs.py  --format rst --split --common-settings > doc/rst/platforms/linux-pkg-table.rst
  Then make any adjustments to add any notes

.. include:: linux-pkg-table.rst
