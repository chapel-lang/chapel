...
assignment
  ...
  to do something else that might be more efficient.
  TODO: Tom wrote "Will not be invoked by the compiler after conversion to
  the new AMM model is complete". Assignment is still called for something
  like myRecordOne = myRecordTwo, right?
