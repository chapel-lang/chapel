...
source to use it, there is a boolean config variable, :var:`VDebugOn`,
...
using the config param :var:`DefaultVDebugOn`.  Setting this config
param to false at compile time requires the variable :var:`VDebugOn`
